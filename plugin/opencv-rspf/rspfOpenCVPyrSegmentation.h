#ifndef rspfOpenCVPyrSegmentation_HEADER
#define rspfOpenCVPyrSegmentation_HEADER
...
class rspfOpenCVPyrSegmentation : public rspfImageSourceFilter
{
public:
   rspfOpenCVPyrSegmentation(rspfObject* owner=NULL);

   virtual ~rspfOpenCVPyrSegmentation();

   rspfString getShortName()const
      {
         return rspfString("OpenCVPyrSegmentation");
      }
   
   rspfString getLongName()const
      {
         return rspfString("OpenCV Pyramid Segmentation");
      }
