...
#include "../plugin/rspfOpenCVPyrSegmentation.h"
...
rspfOpenCVPyrSegmentation * filter = new rspfOpenCVPyrSegmentation();  
...
void usage()   
{
  cout << "test_pyrsegmentation <output_type> <input_im> <output_im> [<spec_file>]" << endl 
