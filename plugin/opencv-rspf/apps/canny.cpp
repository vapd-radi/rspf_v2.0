 ...
 * OVERVIEW:
 *
 * OVERVIEW: Application to test rspfOpenCVCannyFilter 
 *
 */
...
#include "../plugin/rspfOpenCVCannyFilter.h"
...
rspfOpenCVCannyFilter * filter = new rspfOpenCVCannyFilter();  

if(kwl.addFile(argv[3])){
...
void usage()   
{
  cout << "test_canny <output_type> <input_im> <output_im> [<spec_file>]" << endl 
