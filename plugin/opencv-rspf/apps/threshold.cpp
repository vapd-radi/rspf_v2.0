/*!
 *
 * OVERVIEW: Application to test rspfOpenCVThresholdFilter 
 *
 */
...
#include "../plugin/rspfOpenCVThresholdFilter.h"
...
rspfOpenCVThresholdFilter * filter = new rspfOpenCVThresholdFilter();  
...
void usage()   
{
  cout << "test_threshold <output_type> <input_im> <output_im> [<spec_file>]" << endl 
