/*!
 *
 * OVERVIEW: Application to test rspfOpenCVSobelFilter 
 *
 */
...
#include "../plugin/rspfOpenCVLaplaceFilter.h"
...
rspfOpenCVLaplaceFilter * filter = new rspfOpenCVLaplaceFilter();  
...
void usage()   
{
  cout << "test_laplace <output_type> <input_im> <output_im> [<spec_file>]" << endl 
