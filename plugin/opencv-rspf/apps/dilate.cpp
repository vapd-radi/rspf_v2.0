/*!
 *
 * OVERVIEW: Application to test rspfOpenCVErodeFilter 
 *
 */
...
#include "../plugin/rspfOpenCVDilateFilter.h"
...
rspfOpenCVDilateFilter * filter = new rspfOpenCVDilateFilter();  
...
void usage()   
{
  cout << "test_dilate <output_type> <input_im> <output_im> [<spec_file>]" << endl 
