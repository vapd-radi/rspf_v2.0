...
#include "../plugin/rspfOpenCVErodeFilter.h"
...
rspfOpenCVErodeFilter * filter = new rspfOpenCVErodeFilter();  
...
void usage()   
{
  cout << "test_erode <output_type> <input_im> <output_im> [<spec_file>]" << endl 
