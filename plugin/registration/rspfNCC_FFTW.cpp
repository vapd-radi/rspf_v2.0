...
rspfNCC_FFTW::rspfNCC_FFTW(int cy, int cx, const char* wisdom)
 : _mx(0),
   _my(0),
   _sx(0),
   _sy(0),
...
bool
rspfNCC_FFTW::sameDims(int tcy, int tcx)const
{
   return ((tcx==_cx)&&(tcy==_cy));
}

void
rspfNCC_FFTW::ingestMaster(int my,int mx, const double* master)
{
...
void
rspfNCC_FFTW::ingestSlave(int sy, int sx, const double* slave)
{   
   ...
   _srs = new rspfRunningSum(_sy, _sx, slave);
...
void
rspfNCC_FFTW::moments1(int length, const double* table, double* avg, double* std)const
{
