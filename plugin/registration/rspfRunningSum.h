...
//
#ifndef rspfRunningSum_HEADER
#define rspfRunningSum_HEADER
...
{
public:
   rspfRunningSum(int slowdim, int fastdim, const double* table);
   virtual ~rspfRunningSum();
