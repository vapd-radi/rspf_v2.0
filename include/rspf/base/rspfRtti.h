...
class RSPFDLLEXPORT RTTItypeid	
...
class RSPFDLLEXPORT RTTIdyntypeid : public RTTItypeid					//Class for dynamic type creation from user strings.
...
class RSPFDLLEXPORT RTTITypeinfo {							//Implementation of type-related info
		public:
