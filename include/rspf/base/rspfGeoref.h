#ifndef rspfGeoref_HEADER
#define rspfGeoref_HEADER
#include <rspf/base/rspfString.h>
#include <rspf/base/rspfGpt.h>

class RSPFDLLEXPORT rspfGeoref
{
public:
   rspfGeoref(const rspfString &georefString,
               long precision);
   rspfGeoref(const rspfGpt &groundPt);
   rspfGeoref();
   ...
   *    rspfGeoref    : GEOREF coordinate string                  (return)
   */    
   rspfString toString(long precision);
...
private:
   ...
   *    Precision : level of precision specified by the user  (input)
   *    rspfGeoref    : GEOREF coordinate string                  (output)
   */
   ...
   *
   *    rspfGeoref    : GEOREF coordinate string     (input)
