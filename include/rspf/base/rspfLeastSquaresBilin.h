...
//
//*******************************************************************
//  $Id: rspfLeastSquaresBilin.h 9968 2006-11-29 14:01:53Z gpotts $
#ifndef    rspfLeastSquaresBilin_INCLUDE
#define    rspfLeastSquaresBilin_INCLUDE
...
class RSPFDLLEXPORT rspfLeastSquaresBilin
{
public:

   rspfLeastSquaresBilin(const rspfLeastSquaresBilin &);
   /** 
    * Instantiate as zero surface.
    */
   rspfLeastSquaresBilin();
   
   rspfLeastSquaresBilin & operator = (const rspfLeastSquaresBilin &);
   
   /**
    * Free internal storage.
    */
   virtual ~rspfLeastSquaresBilin();
