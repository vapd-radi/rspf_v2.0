...
//*******************************************************************
//  $Id: rspfDms.h 19682 2011-05-31 14:21:20Z dburken $
#ifndef rspfDms_HEADER
#define rspfDms_HEADER
// #include <iostream>

#include <rspf/base/rspfConstants.h> /* for RSPF_DLL macro */
#include <rspf/base/rspfString.h>

class RSPF_DLL rspfDms
{
public:
   // friend std::ostream& operator << (std::ostream& out, const rspfDms &dms);
   ...
   /**
    *
    * Constructor rspfDms(double, bool)
    *
    ...
    *
    */
   rspfDms(double someDegrees, bool latFlag = true);
    ...
    */
   rspfDms(const std::string& value);
    ...
    *
    */
   rspfString toString(const rspfString& formatString=rspfString(""))const;
   ...
   rspfDms& setDegrees(double degrees);

   rspfDms& setLatFlag(bool latFlag){theLatFlag = latFlag;return *this;}
   static const rspf_uint8 theDegreeSign;
...
private:
   ...
   // into the RSPF dms class.  We will use this to aid in
   // formatting DMS data.
   ...
   rspfString degree_to_string(double degrees,
                                char format[],
                                bool lat_flag)const;
