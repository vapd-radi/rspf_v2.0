...
//
// DESCRIPTION:
//   Contains declaration of template class rspfFactory. This is the base
...
//<
//*****************************************************************************
//  $Id: rspfFactoryBaseTemplate.h 14799 2009-06-30 08:54:44Z dburken $

#ifndef rspfFactory_HEADER
#define rspfFactory_HEADER
 ...
 *
 *       class MyFactory : public rspfFactoryBase<MyProductClass>
 *
 ...
 *          - ../rspf_core/projections/factory/rspfProjectionFactory.h
 *          - ../rspf_core/projections/factory/rspfMapProjectionFactory.h
 *          - ../rspf_core/projections/factory/rspfSensorModelFactory.h
 *
 *****************************************************************************/
template <class Product> class RSPFDLLEXPORT rspfFactoryBase 
{
public:
   /*!
    * METHOD: instance()
    ...
    *
    static <rspfFactoryBase-derived class>* instance();
    */
    ...
    */
   virtual Product* create(const rspfString&)     const = 0;
   virtual Product* create(const rspfKeywordlist& kwl,
    ...
    */
   virtual std::list<rspfString> getList() const = 0;
    ...
    */
   void registerFactory(rspfFactoryBase<Product>* new_factory)
...
protected:
   ...
   virtual ~rspfFactoryBase() {}

   /*!
    * Member contains list of sub-factories associated with this factory:
    */
   std::list<rspfFactoryBase<Product>*> theRegistry;
