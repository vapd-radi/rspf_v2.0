...
//
//*************************************************************************
// $Id: rspfKeywordNames.h 19180 2011-03-22 17:36:33Z oscarkramer $

#ifndef rspfKeywordNames_HEADER
#define rspfKeywordNames_HEADER

#include <rspf/base/rspfConstants.h>

class RSPFDLLEXPORT rspfKeywordNames
{
public:
   //***
...
protected:
   rspfKeywordNames();
   rspfKeywordNames(const rspfKeywordNames& rhs);
   const rspfKeywordNames& operator =(const rspfKeywordNames &rhs);
};
