...
// geotiff coordinate transformation code to an rspf projection.
//*******************************************************************
//  $Id: rspfGeoTiffCoordTransformsLut.h 9968 2006-11-29 14:01:53Z gpotts $

#ifndef rspfGeoTiffCoordTransformsLut_HEADER
#define rspfGeoTiffCoordTransformsLut_HEADER

#include <rspf/base/rspfLookUpTable.h>
#include <rspf/base/rspfKeywordNames.h>

class RSPFDLLEXPORT rspfGeoTiffCoordTransformsLut : public rspfLookUpTable
{
public:
   ...
   rspfGeoTiffCoordTransformsLut();

   virtual ~rspfGeoTiffCoordTransformsLut(){}
   
   virtual rspfKeyword getKeyword() const
      { return rspfKeyword("geotiff_coordinate_transform_code", ""); }
};
