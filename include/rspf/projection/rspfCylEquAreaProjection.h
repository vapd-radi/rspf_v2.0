#ifndef rspfCylEquAreaProjection_HEADER
#define rspfCylEquAreaProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfCylEquAreaProjection : public rspfMapProjection
{
public: 
   rspfCylEquAreaProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                             const rspfGpt& origin = rspfGpt());
   rspfCylEquAreaProjection(const rspfEllipsoid& ellipsoid,
                             const rspfGpt& origin,
                             double falseEasting,
                             double falseNorthing);
   ~rspfCylEquAreaProjection(){}
   virtual rspfObject *dup()const
      {
         return new rspfCylEquAreaProjection(*this);
      }
