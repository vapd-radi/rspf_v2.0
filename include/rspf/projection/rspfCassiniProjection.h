#ifndef rspfCassiniProjection_HEADER
#define rspfCassiniProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfCassiniProjection : public rspfMapProjection
{
public:
   rspfCassiniProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                          const rspfGpt& origin = rspfGpt());
   rspfCassiniProjection(const rspfEllipsoid& ellipsoid,
                          const rspfGpt& origin,
                          const double falseEasting,
                          const double falseNorthing);
   ~rspfCassiniProjection(){}
   virtual rspfObject *dup()const{return new rspfCassiniProjection(*this);}
