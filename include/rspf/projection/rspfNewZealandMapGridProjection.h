#ifndef rspfNewZealandMapGridProjection_HEADER
#define rspfNewZealandMapGridProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfNewZealandMapGridProjection : public rspfMapProjection
{
public:
   rspfNewZealandMapGridProjection();
   ~rspfNewZealandMapGridProjection();
   virtual rspfObject* dup()const
      {
         return new rspfNewZealandMapGridProjection(*this);
      }
   virtual void update();   
