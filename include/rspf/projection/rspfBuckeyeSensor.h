#ifndef rspfBuckeyeSensor_HEADER
#define rspfBuckeyeSensor_HEADER
#include "rspfSensorModel.h"
#include "rspfSmacCallibrationSystem.h"
 ...
 * rect: 0 0 7239 5432
 */
class RSPF_DLL rspfBuckeyeSensor : public rspfSensorModel
{
public:
   rspfBuckeyeSensor();
   rspfBuckeyeSensor(const rspfBuckeyeSensor& src)
   :rspfSensorModel(src),
   ...
   {
      return new rspfBuckeyeSensor(*this);
   }
   ...
   void setLensDistortion(rspfSmacCallibrationSystem* distortion)
   {
...
protected:
   ...
   double         m_pitch;
   double         m_yaw;
   rspfDpt       m_principalPoint; // in millimeters
   rspfDpt       m_pixelSize;      // in millimeters
   double         m_focalLength;    // in millimeters
   rspfEcefPoint m_ecefPlatformPosition;
   rspfGpt       m_platformPosition;
   
   rspfRefPtr<rspfSmacCallibrationSystem> m_lensDistortion;
