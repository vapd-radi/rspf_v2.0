#ifndef rspfMillerProjection_HEADER
#define rspfMillerProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfMillerProjection : public rspfMapProjection
{
public:
   rspfMillerProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                         const rspfGpt& origin = rspfGpt());
   rspfMillerProjection(const rspfEllipsoid& ellipsoid,
                         const rspfGpt& origin,
                         const double falseEasting,
                         const double falseNorthing);
   
   ~rspfMillerProjection(){}
   
   virtual rspfObject *dup()const{return new rspfMillerProjection(*this);}
