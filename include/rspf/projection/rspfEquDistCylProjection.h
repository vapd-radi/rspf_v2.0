...
//*******************************************************************
//  $Id: rspfEquDistCylProjection.h 20352 2011-12-12 17:24:52Z dburken $

#ifndef rspfEquDistCylProjection_HEADER
#define rspfEquDistCylProjection_HEADER

#include <rspf/projection/rspfLlxyProjection.h>

class rspfIpt;

class RSPFDLLEXPORT rspfEquDistCylProjection : public rspfMapProjection//public rspfLlxyProjection
{
public:
   rspfEquDistCylProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                             const rspfGpt& origin = rspfGpt());
   rspfEquDistCylProjection(const rspfEllipsoid& ellipsoid,
                             const rspfGpt& origin,
                             double falseEasting,
                             double falseNorthing);
   
   rspfEquDistCylProjection(const rspfEquDistCylProjection& rhs)
     :rspfMapProjection(rhs)
     //      :rspfLlxyProjection(rhs)
      {
         *this = rhs;
      }
   ...
   virtual rspfObject *dup()const
      {
         return new rspfEquDistCylProjection(*this);
      }
    ...
    */
   void worldToLineSample( const rspfGpt& worldPoint,
