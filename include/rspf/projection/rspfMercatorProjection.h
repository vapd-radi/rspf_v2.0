#ifndef rspfMercatorProjection_HEADER
#define rspfMercatorProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfMercatorProjection : public rspfMapProjection
{
public:
   
   rspfMercatorProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                           const rspfGpt& origin = rspfGpt());
   
   rspfMercatorProjection(const rspfEllipsoid& ellipsoid,
                           const rspfGpt& origin,
                           double falseEasting,
                           double falseNorthing,
                           double scaleFactor);
   ~rspfMercatorProjection(){}
   virtual rspfObject *dup()const{return new rspfMercatorProjection(*this);}
