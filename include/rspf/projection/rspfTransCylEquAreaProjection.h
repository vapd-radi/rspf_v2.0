#ifndef rspfTransCylEquAreaProjection_HEADER
#define rspfTransCylEquAreaProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfTransCylEquAreaProjection : public rspfMapProjection
{
public:   
   rspfTransCylEquAreaProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(6378137, 6356752.3142),
                                  const rspfGpt& origin = rspfGpt());
   rspfTransCylEquAreaProjection(const rspfEllipsoid& ellipsoid,
                                  const rspfGpt& origin,
                                  double falseEasting,
                                  double falseNorthing,
                                  double scaleFactor);
   
   ~rspfTransCylEquAreaProjection(){}
   virtual rspfObject *dup()const{return new rspfTransCylEquAreaProjection(*this);}
