#ifndef rspfSmacCallibrationSystem_HEADER
#define rspfSmacCallibrationSystem_HEADER
 ...
 *</pre>
 */
class RSPF_DLL rspfSmacCallibrationSystem : public rspfLensDistortion
{
public:
   rspfSmacCallibrationSystem(const rspfDpt& callibratedCenter = rspfDpt(0.0, 0.0))
   :rspfLensDistortion(callibratedCenter)
   {
   ...
   rspfSmacCallibrationSystem(double k0, double k1, double k2, double k3, double k4,
                               double p1, double p2, double p3, double p4,
                               const rspfDpt& callibratedCenter = rspfDpt(0.0,0.0))
   :rspfLensDistortion(callibratedCenter)
   {
   ...
   rspfSmacCallibrationSystem(const rspfSmacCallibrationSystem& src)
   {
   ...
   {
      return new rspfSmacCallibrationSystem(*this);
   }
