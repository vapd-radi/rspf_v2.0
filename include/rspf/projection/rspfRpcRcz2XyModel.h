#ifndef rspfRpcRcz2XyModel_HEADER
#define rspfRpcRcz2XyModel_HEADER
...
/*!****************************************************************************
*
* CLASS:  rspfRpcRcz2XyModel
*
*****************************************************************************/
class RSPFDLLEXPORT rspfRpcRcz2XyModel : public rspfSensorModel
{
public:
	enum PolynomialType
	{
	...
	rspfRpcRcz2XyModel(const rspfRpcRcz2XyModel& copy_this);
	/** @brief virtual destructor */
	virtual ~rspfRpcRcz2XyModel();
	...
	void setAttributes(rspfRpcRcz2XyModel::rpcModelStruct& model, bool computeGsdFlag=true);
	...
	*/
	void getRpcParameters(rspfRpcRcz2XyModel::rpcModelStruct& model) const;
