#ifndef rspfGnomonicProjection_HEADER
#define rspfGnomonicProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfGnomonicProjection : public rspfMapProjection
{
public:
   rspfGnomonicProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                                const rspfGpt& origin = rspfGpt());
   rspfGnomonicProjection(const rspfEllipsoid& ellipsoid,
                                const rspfGpt& origin,
                                const double falseEasting,
                                const double falseNorthing);
   ~rspfGnomonicProjection(){}
   virtual rspfObject *dup()const
      {
         return new rspfGnomonicProjection(*this);
      }
