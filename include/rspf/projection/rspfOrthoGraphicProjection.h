#ifndef rspfOrthoGraphicProjection_HEADER
#define rspfOrthoGraphicProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class rspfOrthoGraphicProjection : public rspfMapProjection
{
public:
   
   rspfOrthoGraphicProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                               const rspfGpt& origin = rspfGpt());
   rspfOrthoGraphicProjection(const rspfEllipsoid& ellipsoid,
                               const rspfGpt& origin,
                               const double falseEasting,
                               const double falseNorthing);
   ~rspfOrthoGraphicProjection(){}
   
   virtual rspfObject *dup()const
      {
         return new rspfOrthoGraphicProjection(*this);
      }
