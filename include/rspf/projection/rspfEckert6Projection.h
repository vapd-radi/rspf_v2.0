#ifndef rspfEckert6Projection_HEADER
#define rspfEckert6Projection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfEckert6Projection : public rspfMapProjection
{
public:   
   rspfEckert6Projection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                          const rspfGpt& origin = rspfGpt());
   rspfEckert6Projection(const rspfEllipsoid& ellipsoid,
                          const rspfGpt& origin,
                          double falseEasting,
                          double falseNorthing);
   ~rspfEckert6Projection(){}
   virtual rspfObject *dup()const{return new rspfEckert6Projection(*this);}
