#ifndef rspfLambertConformalConicProjection_HEADER
#define rspfLambertConformalConicProjection_HEADER
#include <iosfwd>
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfLambertConformalConicProjection : public rspfMapProjection
{
public:
   rspfLambertConformalConicProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
    ...
    */
   rspfLambertConformalConicProjection(const rspfEllipsoid& ellipsoid,
   ...
   virtual ~rspfLambertConformalConicProjection();
