#ifndef rspfBonneProjection_HEADER
#define rspfBonneProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfBonneProjection : public rspfMapProjection
{
public:
   
   rspfBonneProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                        const rspfGpt& origin = rspfGpt());
   rspfBonneProjection(const rspfEllipsoid& ellipsoid,
                        const rspfGpt& origin,
                        const double falseEasting,
                        const double falseNorthing);
   ~rspfBonneProjection(){}
   virtual rspfObject *dup()const{return new rspfBonneProjection(*this);}
