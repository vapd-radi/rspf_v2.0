 ...
 *                              DEFINES
 */
#define RSPF_MGRS_NO_ERROR                0x0000
#define RSPF_MGRS_LAT_ERROR               0x0001
#define RSPF_MGRS_LON_ERROR               0x0002
#define RSPF_MGRS_STRING_ERROR            0x0004
#define RSPF_MGRS_PRECISION_ERROR         0x0008
#define RSPF_MGRS_A_ERROR                 0x0010
#define RSPF_MGRS_INV_F_ERROR             0x0020
#define RSPF_MGRS_EASTING_ERROR           0x0040
#define RSPF_MGRS_NORTHING_ERROR          0x0080
#define RSPF_MGRS_ZONE_ERROR              0x0100
#define RSPF_MGRS_HEMISPHERE_ERROR        0x0200
/***************************************************************************/
/*
 *                              FUNCTION PROTOTYPES
 */
...
extern "C" {
  #endif
   RSPF_DLL long Set_RSPF_MGRS_Parameters(double a,
                                            double f,
 ...
 */
  RSPF_DLL void Get_RSPF_MGRS_Parameters(double *a,
                                           double *f,
                                           char   *Ellipsoid_Code);
/*
 ...
 */
   RSPF_DLL long Convert_Geodetic_To_RSPF_MGRS (double Latitude,
                                                  double Longitude,
                                                  long   Precision,
                                                  char *MGRS);
/*
 ...
 *  
 */
   RSPF_DLL long Convert_RSPF_MGRS_To_Geodetic (const char *MGRS,
                                                  double *Latitude,
                                                  double *Longitude);
/*
 ...
 *  
 */
   RSPF_DLL long Convert_UTM_To_RSPF_MGRS (long Zone,
                                             char Hemisphere,
                                             double Easting,
                                             double Northing,
                                             long Precision,
 ...
 *    MGRS       : MGRS coordinate string           (output)
 */
  RSPF_DLL long Convert_RSPF_MGRS_To_UTM (const char   *MGRS,
                                            long   *Zone,
                                            char   *Hemisphere,
                                            double *Easting,
                                            double *Northing); 
 ...
 */
   RSPF_DLL long Convert_UPS_To_RSPF_MGRS ( char   Hemisphere,
                                              double Easting,
                                              double Northing,
                                              long Precision,
                                              char *MGRS);
 ...
 *    MGRS          : MGRS coordinate string           (output)
 */
   RSPF_DLL long Convert_RSPF_MGRS_To_UPS ( const char   *MGRS,
                                              char   *Hemisphere,
                                              double *Easting,
                                              double *Northing);
/*
