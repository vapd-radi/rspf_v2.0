#ifndef rspfSinusoidalProjection_HEADER
#define rspfSinusoidalProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfSinusoidalProjection : public rspfMapProjection
{
public:
   rspfSinusoidalProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                             const rspfGpt& origin = rspfGpt());
   
   rspfSinusoidalProjection(const rspfEllipsoid& ellipsoid,
                             const rspfGpt& origin,
                             const double falseEasting,
                             const double falseNorthing);
   
   ~rspfSinusoidalProjection(){}
   virtual rspfObject *dup()const{return new rspfSinusoidalProjection(*this);}
