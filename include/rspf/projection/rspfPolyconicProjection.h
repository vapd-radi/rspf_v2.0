#ifndef rspfPolyconicProjection_HEADER
#define rspfPolyconicProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfPolyconicProjection : public rspfMapProjection
{
public:   
   rspfPolyconicProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                            const rspfGpt& origin = rspfGpt());
   rspfPolyconicProjection(const rspfEllipsoid& ellipsoid,
                            const rspfGpt& origin,
                            const double falseEasting,
                            const double falseNorthing);
   ~rspfPolyconicProjection(){}
   virtual rspfObject *dup()const
      {
         return new rspfPolyconicProjection(*this);
      }
