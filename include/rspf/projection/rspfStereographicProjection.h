#ifndef rspfStereographicProjection_HEADER
#define rspfStereographicProjection_HEADER
#include <rspf/projection/rspfMapProjection.h>
class RSPFDLLEXPORT rspfStereographicProjection : public rspfMapProjection
{
public:   
   rspfStereographicProjection(const rspfEllipsoid& ellipsoid = rspfEllipsoid(),
                            const rspfGpt& origin = rspfGpt());
   rspfStereographicProjection(const rspfEllipsoid& ellipsoid,
                            const rspfGpt& origin,
                            const double falseEasting,
                            const double falseNorthing);
   ~rspfStereographicProjection(){}
   virtual rspfObject *dup()const
      {
         return new rspfStereographicProjection(*this);
      }
