...
//
//*******************************************************************
//  $Id: rspfDiscreteNearestNeighbor.h 17195 2010-04-23 17:32:18Z dburken $
#ifndef rspfDiscreteNearestNeighbor_HEADER
#define rspfDiscreteNearestNeighbor_HEADER
#include <rspf/imaging/rspfDiscreteConvolutionKernel.h>
class rspfDiscreteNearestNeighbor : public rspfDiscreteConvolutionKernel
{
public:
   rspfDiscreteNearestNeighbor()
      :rspfDiscreteConvolutionKernel(1, 1)
   {
