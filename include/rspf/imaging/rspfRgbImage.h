...
//
//*************************************************************************
// $Id: rspfRgbImage.h 15766 2009-10-20 12:37:09Z gpotts $
#ifndef rspfRgbImage_HEADER
#define rspfRgbImage_HEADER
...
class RSPF_DLL rspfRgbImage : public rspfReferenced
{
public:
   rspfRgbImage();
    ...
    * to up to 3.
    */
   rspfRgbImage(rspfRefPtr<rspfImageData>& currentImageData);
   

   /**
    * Will construct a new single band image data object.
    */
   virtual void createNewGrey(rspf_int32 width, rspf_int32 height);

   /**
    * Will construct a new 3 band rgb data object.
    */
   virtual void createNewTrueColor(rspf_int32 width, rspf_int32 height);
    ...
    */
   inline void slowPlotPixel(rspf_int32 x,
                             rspf_int32 y,
                             rspf_uint8 r,
                             rspf_uint8 g,
                             rspf_uint8 b);
    ...
    */
   inline void fastPlotPixel(rspf_int32 x,
                             rspf_int32 y,
                             rspf_uint8 r,
                             rspf_uint8 g,
                             rspf_uint8 b);
    ...
    * pixels
    */
   void setThickness(rspf_int32 thickness);

   /** @return The thickness. */
   rspf_int32 getThickness() const;
    ...
    * to up to 3.
    */
   void setCurrentImageData(rspfRefPtr<rspfImageData>& imageData);
   /**
    * Will return the image data.
    */
   rspfRefPtr<rspfImageData> getImageData();

   /**
    * We will cut and paste the code from
    * drawFilledPolygon(rspfIpt *p, int n).
    */
   void drawFilledPolygon(const std::vector<rspfDpt>& p);
   /**
    * We will cut and paste the code from
    * drawFilledPolygon(rspfIpt *p, int n).
    */
   void drawFilledPolygon(const std::vector<rspfIpt>& p);

   
   /**
    * This will draw a polygon and fill it with the specified color.
    */
   void drawFilledPolygon(rspfDpt *p,
                          int n);
   /**
    * This will draw a polygon and fill it with the specified color.
    */
   void drawFilledPolygon(rspfIpt *p,
                          int n);
   ...
   void drawPolygon(const std::vector<rspfDpt>& p);
   void drawPolygon(const std::vector<rspfIpt>& p);
    ...
    * theColor used is set by the setDrawColor.
    */
   void drawLine(const rspfIpt& start,
                 const rspfIpt& end);
   /**
    * About all the draw routines will call draw line.  it takes a start and
    * an end point and a color value.
    * theColor used is set by the setDrawColor.
    */
   void drawLine(const rspfDpt& start,
                 const rspfDpt& end);
   ...
   void setDrawColor(rspf_uint8 r = 255,
                     rspf_uint8 g = 255,
                     rspf_uint8 b = 255);

   void getDrawColor(rspf_uint8& rCurr,
                     rspf_uint8& gCurr,
                     rspf_uint8& bCurr);
   /**
    ...
    *   x-45, y-34
    */
//   inline void translateToOrigin(rspf_int32& x, rspf_int32& y);
    ...
    *   x-45, y-34
    */
//   inline void translateToOrigin(rspfDpt& pt);
   const rspfRefPtr<rspfImageData> getImageData()const;

protected:
   virtual ~rspfRgbImage();

   /**
    * This object operates on the rspfImageData.  Note the
    * rspfImageData is a band separate so the bands follow sequentially:
...
inline void rspfRgbImage::slowPlotPixel(rspf_int32 x,
                                         rspf_int32 y,
                                         rspf_uint8 r,
                                         rspf_uint8 g,
                                         rspf_uint8 b)
...
inline void rspfRgbImage::fastPlotPixel(rspf_int32 x,
                                         rspf_int32 y,
                                         rspf_uint8 r,
                                         rspf_uint8 g,
                                         rspf_uint8 b)
