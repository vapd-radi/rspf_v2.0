...
//
//-----------------------------------------------------------------------
//$Id: rspfCibCadrgTileSource.h 17954 2010-08-21 20:39:47Z dburken $
#ifndef rspfCibCadrgTileSource_HEADER
#define rspfCibCadrgTileSource_HEADER 1
 ...
 */
class RSPFDLLEXPORT rspfCibCadrgTileSource : public rspfImageHandler
{
public:
   friend class rspfMultiEntryCibCadrg;
  ...
  /**
    ...
    * @code
    *  rspfCibCadrgTileSource* cibCadrgHandler = new rspfCibCadrgTileSource;
    *  rspfKeywordlist kwl;
    ...
    *
    * @see rspfImageHandler for additional keywords.
    *
    ...
    */
   virtual rspf_int32 getCurrentEntryIndex()const;
   
   /**
    * @return The current entry being rendered
    */
   virtual const rspfRpfTocEntry* getCurrentTocEntry()const;

   /**
    * @return The table of contents object.
    */
   virtual const rspfRpfToc*      getToc()const;
   ...
   rspfString getProductScale() const;
    ...
    */
   vector<rspfString> getProductScaleList()const;
    ...
    */
   vector<rspf_int32>      getProductEntryList(const rspfString& productScale)const;
...
protected:
    ...
    */
   virtual ~rspfCibCadrgTileSource();
    ...
    */
   virtual void setTocEntryToRender(const rspfRpfTocEntry* entry);
    ...
    * in the rspfRpfToc.  I am not sure, but I feel these types of
    * searches are specific to the product (CADRG, CIB ...).  This
    * is called immediately after a succesful open of the rspfRpfToc
    */
   const rspfRpfTocEntry* findFirstFrame();
    ...
    * size.
    */
   const rspfRpfTocEntry*      theEntryToRender;
    ...
    * overviews.
    */
   rspf_int32                  theEntryNumberToRender;
    ...
    */
   rspfCibCadrgProductType     theProductType;
   
   mutable rspfRpfFrame*       theWorkFrame;
...
#endif /* #ifndef rspfCibCadrgTileSource_HEADER */
