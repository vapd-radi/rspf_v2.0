...
//
//*************************************************************************
// $Id: rspfGeoPolyCutter.h 19907 2011-08-05 19:55:46Z dburken $
#ifndef rspfGeoPolyCutter_HEADER
#define rspfGeoPolyCutter_HEADER
 ...
 * rspfGeoPolyCutter.
 *
 * This classes overrides the 2-d counter part rspfPolyCutter. It will automatically
 ...
 *
 * you can set the view trough the rspfViewInterface by calling setView(object, true);
 * it will cast to an rspfProjection and use that as the transformation.  For igen this is
 ...
 * geo_polygon0.type:  rspfGeoPolygon
 ...
 * view.type:  rspfEquDistCylProjection
 *
 * </pre> 
 */
class RSPF_DLL rspfGeoPolyCutter : public rspfPolyCutter,
...
public:
    ...
    * /param i index of the polygon to change.
    */
    virtual void setPolygon(const vector<rspfGpt>& polygon,
                            rspf_uint32 i = 0);

   virtual void setPolygon(const rspfGeoPolygon& polygon,
                           rspf_uint32 i = 0);
   /*!
    ...
    */
   virtual void addPolygon(const vector<rspfGpt>& polygon);
    ...
    */
   virtual void addPolygon(const rspfGeoPolygon& polygon);
   ...
   virtual void setNumberOfPolygons(rspf_uint32 count)
      {
         ...
         rspfPolyCutter::setNumberOfPolygons(count);
      }
   /*!
    ...
    * the polygon data.
    */
   virtual std::vector<rspfGeoPolygon>& getGeoPolygonList()
      {
         return theGeoPolygonList;
      }
   virtual const std::vector<rspfGeoPolygon>& getGeoPolygonList()const
      {
         return theGeoPolygonList;
      }
...
protected:
   virtual ~rspfGeoPolyCutter();
   
   /*!
    * The view projection used to project the ground coordinates.
    */
   rspfRefPtr<rspfImageGeometry> theViewProjection;

   std::vector<rspfGeoPolygon> theGeoPolygonList;
