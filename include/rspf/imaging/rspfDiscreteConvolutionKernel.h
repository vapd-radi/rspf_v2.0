...
//
//*******************************************************************
//  $Id: rspfDiscreteConvolutionKernel.h 17195 2010-04-23 17:32:18Z dburken $
#ifndef rspfDiscreteConvolutionKernel_HEADER
#define rspfDiscreteConvolutionKernel_HEADER
#include <vector>
...
{
public:
   rspfDiscreteConvolutionKernel(long width,
                                  long height,
                                  bool doWeightedAverage=true);
   rspfDiscreteConvolutionKernel(const NEWMAT::Matrix& kernel,
                                  bool doWeightedAverage=true);
   virtual ~rspfDiscreteConvolutionKernel();
   ...
   virtual void convolve(const double* data,
                         double& result,
                         double nullPixel=RSPF_DEFAULT_NULL_PIX_DOUBLE)const;
   ...
   virtual void convolve(const short* data,
                         double& result,
                         rspf_sint16 nullPixel=RSPF_DEFAULT_NULL_PIX_SINT16)const;
   ...
   virtual void convolve(const unsigned short* data,
                         double& result,
                         rspf_uint16 nullPixel=RSPF_DEFAULT_NULL_PIX_UINT16)const;
