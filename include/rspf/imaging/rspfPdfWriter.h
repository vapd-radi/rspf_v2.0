...
#ifndef rspfPdfWriter_HEADER
#define rspfPdfWriter_HEADER 1
 ...
 * rspf application with "-T rspfPdfWriter".
 */
class RSPF_DLL rspfPdfWriter : public rspfImageFileWriter
{
public:

   enum rspfPdfImageType
   {
      UNKNOWN = 0,
      JPEG    = 1, // JPEG
   ...
   /**
    * @brief void getImageTypeList(std::vector<rspfString>& imageTypeList)const
    *
...
private:
    ...
    * 
    * @return rspfPdfImageType, e.g. PNG, RAW...
    */
   rspfPdfImageType getImageType() const;   
    ...
    */
#if 0
   void getMediaBoxSize( rspf_uint32 imageWidth,
    ...
    */
   void getLowerLeftPageOffset( const rspfIrect& aoi,
                                rspfIpt& offset ) const;
    ...
    */
   void getLgiDict( rspfImageGeometry* geom,
                    const rspfIrect& aoi,
                    std::string& s ) const;
    ...
    * @param s Initialized by this. 
    */ 
   void getLgiDictProjection( rspfImageGeometry* geom,
                              std::string& s ) const;
    ...
    */
   void getLgiDictCtm( rspfImageGeometry* geom,
                       const rspfIrect& aoi,
                       std::string& s ) const;
    ...
    * @param s Initialized by this or cleared on error.
    */   
   void getLgiDictDatum( rspfImageGeometry* geom,
                         std::string& s ) const;
    ...
    * @param s Initialized by this or cleared on error.
    */   
   void getLgiDictDescription( rspfImageGeometry* geom,
                               std::string& s ) const;
    ...
    */
#if 0
   void getLgiDictNeatline( rspfImageGeometry* geom,
                            std::string& s ) const;
#endif
    ...
    * @param s Initialized by this or cleared on error.
    */
   void getLgiDictProjectionType( rspfImageGeometry* geom,
                                  std::string& s ) const;
    ...
    */
   rspf_uint32 getEpsgCode( const rspfImageGeometry* geom ) const;

#if 0
   void getNumberOfTiles( rspf_uint32 imageWidth,
                          rspf_uint32 imageHeight,
                          rspfIpt& size ) const;
#endif
    ...
    */
   void getTileSize( rspfIpt& tileSize ) const;
   
   /**
    * @return string for x and y in the form of (x=1, y=3): "/Tile_0001_0003"
    */
   std::string getTileString( rspf_uint32 x, rspf_uint32 y ) const;
    ...
    */
   rspfRefPtr<rspfConnectableObject> m_savedInput;
...
#endif /* #ifndef rspfPdfWriter_HEADER */
