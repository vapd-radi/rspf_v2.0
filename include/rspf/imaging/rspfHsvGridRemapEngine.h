...
// AUTHOR: Oscar Kramer
//
// DESCRIPTION: Contains declaration of class rspfHsvGridRemapEngine
//
// LIMITATIONS: None.
//
//*****************************************************************************
//  $Id: rspfHsvGridRemapEngine.h 9094 2006-06-13 19:12:40Z dburken $

#ifndef rspfHsvGridRemapEngine_HEADER
#define rspfHsvGridRemapEngine_HEADER

#include <rspf/imaging/rspfGridRemapEngine.h>

/*!****************************************************************************
 *
 * CLASS: rspfHsvGridRemapEngine 
 *
 *****************************************************************************/
class rspfHsvGridRemapEngine : public rspfGridRemapEngine
{
public:
   rspfHsvGridRemapEngine()
