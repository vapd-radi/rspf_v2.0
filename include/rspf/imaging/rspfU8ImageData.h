...
// Description:
//
// Class declaration of rspfU8ImageData.  Specialized image data object for
// unsigned char data.
//
...
//
//*************************************************************************
// $Id: rspfU8ImageData.h 16052 2009-12-08 22:20:40Z dburken $

#ifndef rspfU8ImageData_HEADER
#define rspfU8ImageData_HEADER

#include <rspf/imaging/rspfImageData.h>
#include <rspf/imaging/rspfNormalizedU8RemapTable.h>

class RSPFDLLEXPORT rspfU8ImageData : public rspfImageData
{
public:
   rspfU8ImageData(rspfSource* source=NULL,
                    rspf_uint32 bands = 1);
   
   rspfU8ImageData(rspfSource* source,
                    rspf_uint32 bands,
                    rspf_uint32 width,
                    rspf_uint32 height);
   
   rspfU8ImageData(const rspfU8ImageData& rhs)
      :rspfImageData(rhs)
      {}
...
protected:
   virtual ~rspfU8ImageData();

private:

   static const rspfNormalizedU8RemapTable m_remapTable;
   
TYPE_DATA
};

inline rspf_float64 rspfU8ImageData::getMinNormalizedPix() const
{
