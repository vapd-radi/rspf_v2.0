...
//
//*************************************************************************
// $Id: rspfHsiRemapper.h 19689 2011-05-31 15:55:21Z gpotts $

#ifndef rspfHsiRemapper_HEADER
#define rspfHsiRemapper_HEADER

#include <rspf/imaging/rspfImageSourceFilter.h>

class RSPFDLLEXPORT rspfHsiRemapper : public rspfImageSourceFilter
{
public:
   enum
   {
   ...
   friend ostream& operator << (ostream& os,  const rspfHsiRemapper& hr);
