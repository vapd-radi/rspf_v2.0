...
//   the band order was changed by a rspfBandSelector then this band 0 will
...
//   
//*************************************************************************
// $Id: rspfHistogramRemapper.h 21787 2012-09-30 21:27:09Z gpotts $
#ifndef rspfHistogramRemapper_HEADER
#define rspfHistogramRemapper_HEADER

#include <rspf/imaging/rspfTableRemapper.h>
#include <rspf/base/rspfMultiResLevelHistogram.h>


class RSPFDLLEXPORT rspfHistogramRemapper : public rspfTableRemapper
{
public:
   enum StretchMode
   {
    ...
    * just the dirty flag will be set.
    */
   void setStretchModeAsString(const rspfString& mode,
    ...
    */
   rspfString getStretchModeString() const;

   /**
    * Returns the number of stretch modes.
    */
   rspf_uint32 getNumberOfStretchModes() const;
    ...
    *   // pseudo code...
    *   rspf_uint32 number_of_modes = remapper->getNumberOfModes()
    *   for (rspf_uint32 i = 0; i < number_of_modes; ++i)
    *   {
    *      addButton(getModeString(i).c_str());
    *   }
    */
   rspfString getStretchModeString(rspf_uint32 index) const;
    ...
    */
   void setLowNormalizedClipPoint(const rspf_float64& clip);
    ...
    */
   void setHighNormalizedClipPoint(const rspf_float64& clip);
    ...
    */
   void setLowClipPoint(const rspf_float64& clip);
    ...
    * - If histogram is not set no action is taken. 
    */
   void setHighClipPoint(const rspf_float64& clip);
    ...
    *   percentage of clip.
    */
   void setMidPoint(const rspf_float64& value);
    ...
    *   percentage of clip.
    */
   void setMinOutputValue(const rspf_float64& value);
    ...
    *   percentage of clip.
    */
   void setMaxOutputValue(const rspf_float64& value);
    ...
    * Will return RSPF_DBL_NAN if:
    * - Band is out of range.
    * - Connection is not complete.
    * - Histogram has not been set.
    */
   rspf_float64 getLowNormalizedClipPoint(rspf_uint32 zero_based_band) const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getLowNormalizedClipPoint() const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getHighNormalizedClipPoint(rspf_uint32 zero_based_band) const;
   /**
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getHighNormalizedClipPoint() const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getLowClipPoint(rspf_uint32 zero_based_band) const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getLowClipPoint() const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getHighClipPoint(rspf_uint32 zero_based_band) const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getHighClipPoint() const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getMidPoint(rspf_uint32 zero_based_band) const;
    ...
    * - Histogram has not been set.
    */
   rspf_float64 getMidPoint() const;
    ...
    * - Connection is not complete.
    */
   rspf_float64 getMinOutputValue(rspf_uint32 zero_based_band) const;
    ...
    * - Connection is not complete.
    */
   rspf_float64 getMinOutputValue() const;
    ...
    * - Connection is not complete.
    */
   rspf_float64 getMaxOutputValue(rspf_uint32 zero_based_band) const;
    ...
    * - Connection is not complete.
    */
   rspf_float64 getMaxOutputValue() const;
    ...
    * on destruction.
    */
   void setHistogram(rspfRefPtr<rspfMultiResLevelHistogram> histogram);
   
   rspfRefPtr<rspfMultiResLevelHistogram> getHistogram();
   rspfRefPtr<const rspfMultiResLevelHistogram> getHistogram()const;
    ...
    */
   rspfRefPtr<rspfHistogram> getHistogram(rspf_uint32 zero_based_band,
                                rspf_uint32 res_level=0) const;
    ...
    */
   bool openHistogram(const rspfFilename& histogram_file);

   /**
    * Returns the currently opened histogram.
    * Returns rspfFilename::NIL if no histogram is loaded.
    */
   rspfFilename getHistogramFile() const;
   ...
   friend ostream& operator <<(ostream& os, const rspfHistogramRemapper& hr);
   /**
   ...
   /**
    * Will test for the input being a rspfHistogramSource and allow pulling the histogram
...
protected:
   /** virtual destructor */
   virtual ~rspfHistogramRemapper();

private:
   // Do not allow copy constructor, operator=.
   rspfHistogramRemapper(const rspfHistogramRemapper& hr);
   rspfHistogramRemapper& operator=(const rspfHistogramRemapper& hr);
    ...
    */
   void initializeClips(rspf_uint32 bands);
   ...
   /**
    * Initialized base class (rspfTableRemapper) values:
    * - theTableBinCount
    * - theTableBandCount
    * - theTableType
    ...
    */
   rspf_uint32 getHistogramBand(rspf_uint32 input_band) const;
   ...
   */
   ...
   bool                          theDirtyFlag;
   mutable rspfRefPtr<rspfMultiResLevelHistogram>  theHistogram;
   vector<rspf_float64>         theNormalizedLowClipPoint;
   vector<rspf_float64>         theNormalizedHighClipPoint;
   vector<rspf_float64>         theMidPoint;
   vector<rspf_float64>         theMinOutputValue;
   vector<rspf_float64>         theMaxOutputValue;

   // Maps zero based band to histogram band.
   vector<rspf_uint32>          theBandList;
...
#endif  /* #ifndef rspfHistogramRemapper_HEADER */
