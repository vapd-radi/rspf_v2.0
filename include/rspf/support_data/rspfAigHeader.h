...
//
//*******************************************************************
// $Id: rspfAigHeader.h 9968 2006-11-29 14:01:53Z gpotts $

#ifndef rspfAigHeader_HEADER
#define rspfAigHeader_HEADER
#include <iostream>
...
{
public:
   friend std::ostream& operator <<(std::ostream& out, const rspfAigHeader& header)
      {
