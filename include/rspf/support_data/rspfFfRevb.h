...
//
//********************************************************************
// $Id: rspfFfRevb.h 10384 2007-01-26 20:32:12Z gpotts $

#ifndef rspfFfRevb_HEADER
#define rspfFfRevb_HEADER
...
// CLASS: rspfFfRevb.h
//***************************************************************************
class rspfFfRevb : public rspfReferenced
{
public:
   rspfFfRevb  ();
   rspfFfRevb  (const char* headerFile);
   ~rspfFfRevb (){};
   ...
   friend ostream& operator<<(ostream& os, const rspfFfRevb& head);
