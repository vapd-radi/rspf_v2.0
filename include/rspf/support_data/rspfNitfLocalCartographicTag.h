#ifndef rspfNitfLocalCartographicTag_HEADER
#define rspfNitfLocalCartographicTag_HEADER
#include <rspf/support_data/rspfNitfRegisteredTag.h>

class rspfNitfLocalCartographicTag : public rspfNitfRegisteredTag
{
public:
   rspfNitfLocalCartographicTag();
   virtual ~rspfNitfLocalCartographicTag();
   ...
   void setLengthUnits(const rspfString& units);
   void setEastingInterval(rspf_uint32 eastingInterval);
   void setNorthingInterval(rspf_uint32 northingInterval);
   void setEastingReferenceOrigin(rspf_float64 east);
   void setNorthingReferenceOrigin(rspf_float64 north);
