/*********************************************************************************************
 *
 * rspfJpipMessage was modified from the oiginal source found in a JAVA based framework called
 *
 * CADI Software - a JPIP Client/Server framework
 * 
 *********************************************************************************************/
#ifndef rspfJpipMessageHeader_HEADER
#define rspfJpipMessageHeader_HEADER
#include <rspf/base/rspfConstants.h>
#include <rspf/base/rspfString.h>
#include <sstream>

class RSPF_DLL rspfJpipMessageHeader : public rspfReferenced
{
public:
    rspfJpipMessageHeader()
    :m_isLastByte(true),
    ...
    rspfString toString() const
    {
        ...
        out << "m_isLastByte: " << rspfString::toString(m_isLastByte) << "\n"
    ...
    rspf_int64 m_inClassIdentifier;
