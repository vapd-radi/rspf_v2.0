...
//
//********************************************************************
// $Id: rspfDtedDsi.h 16104 2009-12-17 18:09:59Z gpotts $

#ifndef rspfDtedDsi_H
#define rspfDtedDsi_H
#include <iosfwd>
...
class RSPF_DLL rspfDtedDsi : public rspfErrorStatusInterface
{
public:
   rspfDtedDsi(const rspfFilename& dted_file="", rspf_int32 offset=0);
   rspfDtedDsi(std::istream& in);
   ...
   rspfString matchMergeVersion()      const;
   rspfString maintanenceDate()        const;
   rspfString matchMergeDate()         const;
   rspfString maintenanceCode()        const;
   rspfString producerCode()           const;
   rspfString productStockSpecNumber() const;
   rspfString productSpecNumber()      const;
   rspfString productSpecDate()        const;
   rspfString verticalDatum()          const;
   rspfString horizontalDatum()        const;
   rspfString compilationDate()        const;
   rspfString latOrigin()              const;
   rspfString lonOrigin()              const;
   rspfString latSW()                  const;
   rspfString lonSW()                  const;
   rspfString latNW()                  const;
   rspfString lonNW()                  const;
   rspfString latNE()                  const;
   rspfString lonNE()                  const;
   rspfString latSE()                  const;
   rspfString lonSE()                  const;

   rspfString orientation()    const;
   rspfString latInterval()    const;
   rspfString lonInterval()    const;
   rspf_int32 numLatPoints()   const;
   rspf_int32 numLonLines()    const;
   rspf_int32 cellIndicator()  const;
   rspf_int32 startOffset()    const;
   rspf_int32 stopOffset()     const;
   
   friend RSPF_DLL std::ostream& operator<<( std::ostream& os,
                                              const rspfDtedDsi& dsi);
...
private:
   // Do not allow...
   rspfDtedDsi(const rspfDtedDsi& source);
   const rspfDtedDsi& operator=(const rspfDtedDsi& rhs);
