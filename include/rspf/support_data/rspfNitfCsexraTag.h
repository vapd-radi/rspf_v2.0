...
#ifndef rspfNitfCsexraTag_HEADER
#define rspfNitfCsexraTag_HEADER 1
#include <rspf/support_data/rspfNitfRegisteredTag.h>

class RSPF_DLL rspfNitfCsexraTag : public rspfNitfRegisteredTag
{
public:
    ...
    */
   rspfString getNumSamples() const;
...
#endif /* matches #ifndef rspfNitfCsexraTag_HEADER */
