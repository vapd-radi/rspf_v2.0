...
// 
//********************************************************************
// $Id: rspfNitfProjectionParameterTag.h 22013 2012-12-19 17:37:20Z dburken $

#ifndef rspfNitfProjectionParameterTag_HEADER
#define rspfNitfProjectionParameterTag_HEADER
#include <vector>
#include <rspf/support_data/rspfNitfRegisteredTag.h>

class RSPF_DLL rspfNitfProjectionParameterTag : public rspfNitfRegisteredTag
{
public:
   rspfNitfProjectionParameterTag();
   virtual ~rspfNitfProjectionParameterTag();
   ...
   virtual void addParameter(const rspfString& param);
   virtual void addParameter(const rspf_float64& param);
   void setName(const rspfString& name);
   void setCode(const rspfString& code);
   rspfString getName()const;
   rspfString getCode()const;
...
protected:
    ...
    */
   std::vector<rspfString> theProjectionParameters;
