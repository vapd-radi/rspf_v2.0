...
//
//********************************************************************
// $Id: rspfDemStats.h 7174 2005-01-11 18:10:38Z dburken $

#ifndef rspfDemStats_HEADER
#define rspfDemStats_HEADER
...
public:
   ...
   friend std::ostream& operator<<(std::ostream& s,
                                   rspfDemStats const& stats);
   friend std::istream& operator>>(std::istream& s, rspfDemStats& stats);
...
#endif // #ifndef rspfDemStats_HEADER
