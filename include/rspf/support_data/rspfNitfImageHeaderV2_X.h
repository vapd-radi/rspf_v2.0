#ifndef rspfNitfImageHeaderV2_X_HEADER
#define rspfNitfImageHeaderV2_X_HEADER
#include <rspf/base/rspfConstants.h>
#include <rspf/support_data/rspfNitfImageHeader.h>

class RSPF_DLL rspfNitfImageHeaderV2_X : public rspfNitfImageHeader
{
public:
   rspfNitfImageHeaderV2_X();

   /** @brief Returns the zero based image rectangle. */
   virtual rspfIrect  getImageRect()const;
    ...
    */
   virtual rspfIrect  getBlockImageRect()const;
   
   void setImageId(const rspfString& value);
   void setAquisitionDateTime(const rspfString& value);
   void setTargetId(const rspfString& value);
   void setTitle(const rspfString& value);
   void setSecurityClassification(const rspfString& value);
   void setEncryption(const rspfString& value);
   void setImageSource(const rspfString& value);
   void setJustification(const rspfString& value);
   void setCoordinateSystem(const rspfString& value);
   void setGeographicLocation(const rspfString& value);
   void setNumberOfComments(const rspfString& value);
   void setCompression(const rspfString& value);
   void setCompressionRateCode(const rspfString& value);
   void setDisplayLevel(const rspfString& value);
   void setAttachmentLevel(const rspfString& value);
   void setPixelType(const rspfString& pixelType = rspfString("INT"));
   void setBitsPerPixel(rspf_uint32 bitsPerPixel);
   void setActualBitsPerPixel(rspf_uint32 bitsPerPixel);
   void setImageMode(char mode);
   void setCategory(const rspfString& category);
   void setRepresentation(const rspfString& rep);
   void setBlocksPerRow(rspf_uint32 blocks);
   void setBlocksPerCol(rspf_uint32 blocks);
   void setNumberOfPixelsPerBlockRow(rspf_uint32 pixels);
   void setNumberOfPixelsPerBlockCol(rspf_uint32 pixels);

   rspf_uint64 getDataLocation()const;
   rspfString getImageId()const;
   rspfString getAquisitionDateTime()const;
   rspfString getTargetId()const;
   rspfString getTitle()const;
   rspfString getSecurityClassification()const;
   rspfString getEncryption()const;
   rspfString getImageSource()const;
   rspfString getJustification()const;
   rspfString getCoordinateSystem()const;
   rspfString getGeographicLocation()const;

   
   rspfString getNumberOfComments()const;
   rspfString getCompressionCode()const;
   rspfString getCompressionRateCode()const;
   rspf_uint32 getDisplayLevel()const;
   rspf_uint32 getAttachmentLevel()const;
   rspfString getPixelType()const;
   rspf_uint32 getBitsPerPixel()const;
   rspf_uint32 getActualBitsPerPixel()const;
   char getImageMode()const;
   rspfString getCategory()const;
   rspfString getRepresentation()const;
   rspf_uint32 getBlocksPerRow()const;
   rspf_uint32 getBlocksPerCol()const;
   rspf_uint32 getNumberOfPixelsPerBlockRow()const;
   rspf_uint32 getNumberOfPixelsPerBlockCol()const;
    ...
    * @return IMAG field
    */
   virtual rspfString  getImageMagnification()const;

   /**
    * @brief Gets the ILOC field as an rspfIpt. Satisfies pure virtual.
    * @param loc Initialized with the field.
    * @note: Do not confuse with "data location".
    */
   virtual void getImageLocation(rspfIpt& loc)const;
   
   virtual void setGeographicLocationDms(const rspfDpt& ul,
                                         const rspfDpt& ur,
                                         const rspfDpt& lr,
                                         const rspfDpt& ll);
   
   virtual void setGeographicLocationDecimalDegrees(const rspfDpt& ul,
                                                    const rspfDpt& ur,
                                                    const rspfDpt& lr,
                                                    const rspfDpt& ll);
   virtual void setUtmNorth(rspf_uint32 zone,
                            const rspfDpt& ul,
                            const rspfDpt& ur,
                            const rspfDpt& lr,
                            const rspfDpt& ll);
   
   virtual void setUtmSouth(rspf_uint32 zone,
                            const rspfDpt& ul,
                            const rspfDpt& ur,
                            const rspfDpt& lr,
                            const rspfDpt& ll);
   ...
   static const rspfString IM_KW;
   static const rspfString IID1_KW;
   static const rspfString IDATIM_KW;
   static const rspfString TGTID_KW;
   static const rspfString IID2_KW;
   static const rspfString ITITLE_KW; // also IID2 in 2.1 spec and ITITLE in 2.0 spec
   static const rspfString ISCLAS_KW;
   static const rspfString ENCRYP_KW;
   static const rspfString ISORCE_KW;
   static const rspfString NROWS_KW;
   static const rspfString NCOLS_KW;
   static const rspfString PVTYPE_KW;
   static const rspfString IREP_KW;
   static const rspfString ICAT_KW;
   static const rspfString ABPP_KW;
   static const rspfString PJUST_KW;
   static const rspfString ICORDS_KW;
   static const rspfString IGEOLO_KW;
   static const rspfString NICOM_KW;
   static const rspfString ICOM_KW;
   static const rspfString IC_KW;
   static const rspfString COMRAT_KW;
   static const rspfString NBANDS_KW;
   static const rspfString ISYNC_KW;
   static const rspfString IMODE_KW;
   static const rspfString NBPR_KW;
   static const rspfString NBPC_KW;
   static const rspfString NPPBH_KW;
   static const rspfString NPPBV_KW;
   static const rspfString NBPP_KW;
   static const rspfString IDLVL_KW;
   static const rspfString IALVL_KW;
   static const rspfString ILOC_KW;
   static const rspfString IMAG_KW;
   static const rspfString UDIDL_KW;
   static const rspfString UDOFL_KW;
   static const rspfString IXSHDL_KW;
   static const rspfString IXSOFL_KW;
   static const rspfString IMDATOFF_KW;
   static const rspfString BMRLNTH_KW;
...
protected:
   ...
   */
    ...
    * 
    */
   rspf_uint32 theBlockedImageDataOffset;
    ...
    * included.
    */
   rspf_uint16 theBlockMaskRecordLength;
    ...
    */
   rspf_uint16 thePadPixelMaskRecordLength;
    ...
    *  
    */
   rspf_uint16 theTransparentOutputPixelCodeLength;
    ...
    */
   rspf_uint16 thePadOutputPixelCode;

   std::vector<rspf_uint32> theBlockMaskRecords;
   std::vector<rspf_uint32> thePadPixelMaskRecords;
   rspfRefPtr<rspfNitfCompressionHeader> theCompressionHeader;
   rspf_uint64 theDataLocation;
