...
// 
//********************************************************************
// $Id: rspfNitfSymbolHeaderV2_0.h 9094 2006-06-13 19:12:40Z dburken $
#ifndef rspfNitfSymbolHeaderV2_0_HEADER
#define rspfNitfSymbolHeaderV2_0_HEADER
#include <rspf/support_data/rspfNitfSymbolHeader.h>
#include <rspf/support_data/rspfNitfImageLutV2_0.h>

class rspfNitfSymbolHeaderV2_0 : public rspfNitfSymbolHeader
{
public:
   rspfNitfSymbolHeaderV2_0();
   virtual ~rspfNitfSymbolHeaderV2_0(){}
   
   virtual void parseStream(std::istream &in);
   virtual std::ostream& print(std::ostream &out)const;
   virtual rspf_int32 getDisplayLevel()const;
...
private:
    ...
    */
   rspfNitfImageLutV2_0 theSymbolLutData;
