...
//
//********************************************************************
// $Id: rspfFfRevc.h 9967 2006-11-29 02:01:23Z gpotts $

#ifndef rspfFfRevc_HEADER
#define rspfFfRevc_HEADER
#include <iostream>
using namespace std;
...
public:
   rspfFfRevc  ();
   rspfFfRevc  (const char* headerFile);
   ~rspfFfRevc (){};
   ...
   friend ostream& operator<<(ostream& os, const rspfFfRevc& head);
   ...
   int    fraction(int sceneNbr=0) const;
      ...
      //  Currently uses the1stPathRowNumber string.
      //<
   rspfString subScene(int sceneNbr=0) const;
      //> Returns the sub scene as an string from the pathRowString.
      //  Currently uses the1stPathRowNumber string.
      //<

   rspfString pathRow(int sceneNbr=0) const;
