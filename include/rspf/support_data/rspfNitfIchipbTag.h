...
//
//----------------------------------------------------------------------------
// $Id: rspfNitfIchipbTag.h 22013 2012-12-19 17:37:20Z dburken $
#ifndef rspfNitfIchipbTag_HEADER
#define rspfNitfIchipbTag_HEADER 1
...
class RSPF_DLL rspfNitfIchipbTag : public rspfNitfRegisteredTag
{
public:
   enum 
   {
    ...
    */
   rspf_float64 getScaleFactor() const;
    ...
    * point method where (0,0) refers to the center of the pixel.
    */
   void getFullImageRect(rspfDrect& rect) const;

   rspf2dTo2dTransform* newTransform()const;
...
#endif /* End of "#ifndef rspfNitfIchipbTag_HEADER" */
