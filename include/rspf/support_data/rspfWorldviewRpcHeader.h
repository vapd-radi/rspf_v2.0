#ifndef rspfWorldviewRpcHeader_HEADER
#define rspfWorldviewRpcHeader_HEADER
#include <iostream>
#include <rspf/base/rspfErrorStatusInterface.h>
#include <rspf/base/rspfFilename.h>
class RSPF_DLL rspfWorldviewRpcHeader : public rspfErrorStatusInterface
{
public:
  friend RSPF_DLL std::ostream& operator << (std::ostream& out,
			       const rspfWorldviewRpcHeader& data);
  rspfWorldviewRpcHeader();
