...
// 
//********************************************************************
// $Id: rspfNitfGeoPositioningTag.h 22013 2012-12-19 17:37:20Z dburken $
//
#ifndef rspfNitfGeoPositioningTag_HEADER
#define rspfNitfGeoPositioningTag_HEADER 1
#include <rspf/support_data/rspfNitfRegisteredTag.h>

class RSPF_DLL rspfNitfGeoPositioningTag : public rspfNitfRegisteredTag
{
public:
   rspfNitfGeoPositioningTag();
   virtual ~rspfNitfGeoPositioningTag();
