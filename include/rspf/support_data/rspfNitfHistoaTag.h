...
// 
//----------------------------------------------------------------------------
// $Id: rspfNitfHistoaTag.h 22013 2012-12-19 17:37:20Z dburken $

#ifndef rspfNitfHistoaTag_HEADER
#define rspfNitfHistoaTag_HEADER 1
 ...
 * modified.
 */
class RSPF_DLL rspfNitfHistoaProcessingEvent
{
public:
   enum
   {
   ...
   rspfNitfHistoaProcessingEvent();
   rspf_uint32 getSizeInBytes()const;
...
}; // Matches: class RSPF_DLL rspfNitfHistoaProcessingEvent

class RSPF_DLL rspfNitfHistoaTag : public rspfNitfRegisteredTag
{
public:
   enum
   {
...
protected:
   ...
   std::vector<rspfNitfHistoaProcessingEvent> m_eventList;
   
}; // Matches: class RSPF_DLL rspfNitfHistoaTag

#endif /* #ifndef rspfNitfHistoaTag_HEADER */
