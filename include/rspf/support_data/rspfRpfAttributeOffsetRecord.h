#ifndef rspfRpfAttributeOffsetRecord_HEADER
#define rspfRpfAttributeOffsetRecord_HEADER
#include <iostream>
using namespace std;
...
class rspfRpfAttributeOffsetRecord
{
public:
   friend ostream& operator <<(ostream& out,
                               const rspfRpfAttributeOffsetRecord& data);

   rspfRpfAttributeOffsetRecord();
   virtual ~rspfRpfAttributeOffsetRecord(){}

   rspfErrorCode parseStream(istream& in, rspfByteOrder byteOrder);
   void print(ostream& out)const;
   rspf_uint16  getAttributeId()const{return theAttributeId;}
   rspf_uint8   getParamterId()const{return theParameterId;}
   rspf_uint32  getAttributeRecordOffset()const{return theAttributeRecordOffset;}
...
private:
    ...
    * coverage table.
    */
    rspf_uint8 theArealCoverageSequenceNumber;
    ...
    */
   rspf_uint32 theAttributeRecordOffset;
};
