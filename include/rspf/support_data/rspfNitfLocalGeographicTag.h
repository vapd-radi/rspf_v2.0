...
// 
//********************************************************************
// $Id: rspfNitfLocalGeographicTag.h 22013 2012-12-19 17:37:20Z dburken $
#ifndef rspfNitfLocalGeographicTag_HEADER
#define rspfNitfLocalGeographicTag_HEADER
#include <rspf/support_data/rspfNitfRegisteredTag.h>

class RSPF_DLL rspfNitfLocalGeographicTag : public rspfNitfRegisteredTag
{
public:
   rspfNitfLocalGeographicTag();
   virtual ~rspfNitfLocalGeographicTag();
