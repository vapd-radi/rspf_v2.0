...
#ifndef rspfNitfAcftbTag_HEADER
#define rspfNitfAcftbTag_HEADER

#include <rspf/support_data/rspfNitfRegisteredTag.h>

class RSPF_DLL rspfNitfAcftbTag : public rspfNitfRegisteredTag
{
public:
   ...
   rspfString getFocalLength()const;
   rspfString getColumnSpacing()const;
   rspfString getColumnSpacingUnits()const;
   rspfString getRowSpacing()const;
   rspfString getRowSpacingUnits()const;
   /**
...
#endif /* matches #ifndef rspfNitfAcftbTag_HEADER */
