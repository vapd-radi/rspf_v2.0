...
//
//----------------------------------------------------------------------------
// $Id: rspfNitfCommon.h 15410 2009-09-11 19:45:38Z dburken $
#ifndef rspfNitfCommon_HEADER
#define rspfNitfCommon_HEADER
...
/** class rspfNitfCommon for global utility methods */   
class RSPF_DLL rspfNitfCommon
{
public:
    ...
    */
   static rspfString convertToScientificString(const rspf_float64& aValue,
                                                rspf_uint32 size);
    ...
    */
   static rspfString convertToDoubleString(const rspf_float64& aValue,
    ...
    * @param size total size of the string.
    */
   static rspfString convertToUIntString(rspf_uint32 aValue,
                                          rspf_uint32 size);
    ...
    * @param size total size of the string.
    */
   static rspfString convertToIntString(rspf_int32 aValue,
                                         rspf_uint32 size);
    ...
    * size of the string.
    */
   static rspfString convertToDdLatLonLocString(const rspfDpt& pt,
                                                 rspf_uint32 precision);
    ...
    */
   static rspfString encodeUtm(
                                rspf_uint32 zone,
                                const rspfDpt& ul,
                                const rspfDpt& ur,
                                const rspfDpt& lr,
                                const rspfDpt& ll);
   static rspfString encodeGeographicDms(
                                          const rspfDpt& ul,
                                          const rspfDpt& ur,
                                          const rspfDpt& lr,
                                          const rspfDpt& ll);
   static rspfString encodeGeographicDecimalDegrees(
                                                     const rspfDpt& ul,
                                                     const rspfDpt& ur,
                                                     const rspfDpt& lr,
                                                     const rspfDpt& ll);
    ...
    */
   static rspfString getNitfPixelType(rspfScalarType scalarType);
    ...
    */
   static rspfString getCompressionRate(const rspfIrect& rect,
                                         rspf_uint32 bands,
                                         rspfScalarType scalar,
                                         rspf_uint64 lengthInBytes);
   
   
}; // End of class rspfNitfCommon.
   
#endif /* #ifndef rspfNitfCommon_HEADER */
