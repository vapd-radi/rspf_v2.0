#include <rspf/base/rspfGeoref.h>
...
rspfGeoref::rspfGeoref(const rspfString &georefString,
                         long /* precision */ )
{
   double lat, lon;
...
rspfGeoref::rspfGeoref(const rspfGpt &groundPt)
{
   thePt = groundPt;
}

rspfGeoref::rspfGeoref()
{
}

rspfString rspfGeoref::toString(long precision)
{
   ...
   if(result == GEOREF_NO_ERROR)
   {
      return rspfString(resultString);
   }
...
long rspfGeoref::Convert_GEOREF_To_Geodetic (char *georef,
                                              double *latitude, 
                                              double *longitude)
...
long rspfGeoref::Convert_Geodetic_To_GEOREF (double latitude,
                                              double longitude,
                                              long precision,
                                              char *georef)
