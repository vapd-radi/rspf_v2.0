...
//
//*************************************************************************
// $Id: rspfRefreshEvent.cpp 19717 2011-06-03 17:26:52Z gpotts $
#include <rspf/base/rspfRefreshEvent.h>

RTTI_DEF1(rspfRefreshEvent, "rspfRefreshEvent", rspfEvent);


void rspfRefreshEvent::setRefreshType(int refreshType, bool on)
{
   if(on)
   {
