...
static rspfTrace traceDebug(rspfString("rspfWLSBundleSolution:debug"));
static rspfTrace traceExec(rspfString("rspfWLSBundleSolution:exec"));


//*****************************************************************************
//  METHOD: rspfWLSBundleSolution::rspfWLSBundleSolution()
//  
//  Constructor.
//  
//*****************************************************************************
rspfWLSBundleSolution::rspfWLSBundleSolution()
{
}
...
rspfWLSBundleSolution::~rspfWLSBundleSolution()
{
   if (traceExec())  rspfNotify(rspfNotifyLevel_DEBUG)
      << "DEBUG: ~rspfWLSBundleSolution(): returning..." << std::endl;
}


//*****************************************************************************
//  METHOD: rspfWLSBundleSolution::run()
//  
//  Execute solution.
//  
//*****************************************************************************
bool rspfWLSBundleSolution::run(rspfAdjSolutionAttributes* solAttributes)
{
   if (traceDebug())
   {
      rspfNotify(rspfNotifyLevel_DEBUG)
         << "\nrspfWLSBundleSolution::run DEBUG:" << std::endl;
   }
...
//*****************************************************************************
bool rspfWLSBundleSolution::recurFwd(double* d, double* c, std::vector<double>& tmp, std::vector<int>& nz, int rank)
{
...
//*****************************************************************************
bool rspfWLSBundleSolution::recurBack(double* d, int rank)
{
...
//
//*****************************************************************************
void rspfWLSBundleSolution::trimv(double* pc, double* h, int pcIndex, int hIndex, int mr, std::vector<double>& sum)
{
   for (int k=1; k<=mr; k++)
      sum[k]=0.0;
...
//*****************************************************************************
void rspfWLSBundleSolution::moveAndNegate
...
*******************************************************************************/
bool rspfWLSBundleSolution::solveSystem(double* d, double* c, double* delta, int rank)
{
