...
//
//*************************************************************************
// $Id: rspfUsgsQuad.cpp 12953 2008-06-01 16:24:05Z dburken $
...
//***
static rspfTrace traceDebug("USGS_quad::debug");


rspfUsgsQuad::rspfUsgsQuad(const rspfGpt& lrGpt)
   :
...

{
   ...
   double latFraction = (lrGpt.lat / QUAD_SIZE_IN_DEGREES) -
                        rspf::round<int>((lrGpt.lat) / QUAD_SIZE_IN_DEGREES);
   double lonFraction = (lrGpt.lon / QUAD_SIZE_IN_DEGREES) -
                        rspf::round<int>((lrGpt.lon) / QUAD_SIZE_IN_DEGREES);
...
//***************************************************************************
rspfUsgsQuad::rspfUsgsQuad(const rspfString& name,
...
//      thePaddingInDegrees(0.0, 0.0),
{
   static const char MODULE[] = "rspfUsgsQuad::rspfUsgsQuad";
   ...
   if (!datum)
   {
      if (traceDebug())
      {
         rspfNotify(rspfNotifyLevel_FATAL)
            << "FATAL: " << MODULE << "\n"
            << "rspfDatum pointer passed in is null. Returning...\n";
      }
      return;
   }
   ...
   //***
//    rspfGpt metersPerDegree = theQuadLowerRightCorner.metersPerDegree();
...
void rspfUsgsQuad::setQuadName(const rspfString& name)
{
   const char* MODULE = "rspfUsgsQuad::setQuadName";
   rspfString qqName = name;
...
void rspfUsgsQuad::getQuadList(vector<rspfUsgsQuad>& result,
                                const rspfGrect& rect)
{
   result.clear();
//   QUAD_SIZE_IN_DEGREES;

   rspfGpt point = rect.ul();

   while(rect.pointWithin(point))
   {
      while(rect.pointWithin(point))
      {
         result.push_back(rspfUsgsQuad(point));
...
//***************************************************************************
// rspfUsgsQuad::quarterQuadSegRect()
//***************************************************************************
rspfGrect rspfUsgsQuad::quarterQuadSegRect(char seg)
{
   static const char MODULE[] = "rspfUsgsQuad::quarterQuadSegRect";
...
//***************************************************************************
// rspfUsgsQuad::quarterQuadRect()
//***************************************************************************
rspfGrect rspfUsgsQuad::quarterQuadRect() const
{
   static const char MODULE[] = "rspfUsgsQuad::quarterQuadRect";
...
//***************************************************************************
// rspfUsgsQuad::quadRect()
//***************************************************************************
rspfGrect rspfUsgsQuad::quadRect() const
{
   static const char MODULE[] = "rspfUsgsQuad::quadRect";
...
//***************************************************************************
// rspfUsgsQuad::quarterQuadSegKwRect(char seg)
//***************************************************************************
rspfString rspfUsgsQuad::quarterQuadSegKwRect(char seg)
{
   static const char MODULE[] = "rspfUsgsQuad::quarterQuadSegKwRect";
   ...
   rspfGrect rect = quarterQuadSegRect(seg);
...
//***************************************************************************
// rspfUsgsQuad::quarterQuadKwRect()
//***************************************************************************
rspfString rspfUsgsQuad::quarterQuadKwRect() const
{
//   static const char MODULE[] = "rspfUsgsQuad::quarterQuadKwRect";

   rspfGrect rect = quarterQuadRect();
...
//***************************************************************************
// rspfUsgsQuad::quadKwRect()
//***************************************************************************
rspfString rspfUsgsQuad::quadKwRect() const
{
//   static const char MODULE[] = "rspfUsgsQuad::quadKwRect";

   rspfGrect rect = quadRect();
