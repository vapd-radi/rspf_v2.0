...
// Description:
//
// Contains class definition for rspfGeoTiffDatumLut.
//*******************************************************************
//  $Id: rspfGeoTiffDatumLut.cpp 16472 2010-02-01 19:52:27Z gpotts $
...
// Public Constructor:
//*******************************************************************
rspfGeoTiffDatumLut::rspfGeoTiffDatumLut()
   :
...
rspfKeyword rspfGeoTiffDatumLut::getKeyword() const
{
   return rspfKeyword("geotiff_datum_code", "");
}
