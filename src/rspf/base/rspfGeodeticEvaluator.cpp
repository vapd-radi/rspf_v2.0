...
#include <rspf/base/rspfGeodeticEvaluator.h>
...
static rspfTrace traceDebug(rspfString("rspfGeodeticEvaluator:debug"));
static rspfTrace traceExec(rspfString("rspfGeodeticEvaluator:exec"));


//*****************************************************************************
//  METHOD: rspfGeodeticEvaluator::rspfGeodeticEvaluator()
//  
//  Constructor.
//  
//*****************************************************************************
rspfGeodeticEvaluator::rspfGeodeticEvaluator(const rspfEllipsoid& ell)
   :
      m_A(ell.getA()),
      m_B(ell.getB()),
...
//  
//*****************************************************************************
rspfGeodeticEvaluator::~rspfGeodeticEvaluator()
{
   if (traceExec())  rspfNotify(rspfNotifyLevel_DEBUG)
      << "DEBUG: ~rspfGeodeticEvaluator(): returning..." << std::endl;
}


//*****************************************************************************
//  METHOD: rspfGeodeticEvaluator::direct()
//  
...
//  
//*****************************************************************************
bool rspfGeodeticEvaluator::direct(const rspfGpt& p1,
                                    const double& d,
                                    const double& az12,
                                    rspfGpt& p2,
                                    double& az21)
{
   if (traceDebug())
   {
      rspfNotify(rspfNotifyLevel_DEBUG)
         << "\nrspfGeodeticEvaluator::direct DEBUG:" << std::endl;
   }
...
//*****************************************************************************
//  METHOD: rspfGeodeticEvaluator::inverse()
//  
//  Equation numbers reference Vincenty:
//    http://www.ngs.noaa.gov/PUBS_LIB/inverse.pdf
//
...
//  
//*****************************************************************************
bool rspfGeodeticEvaluator::inverse(const rspfGpt& p1,
                                     const rspfGpt& p2,
                                     double& d,
                                     double& az12,
                                     double& az21)
{
   ...
   {
      rspfNotify(rspfNotifyLevel_DEBUG)
         << "\nrspfGeodeticEvaluator::inverse DEBUG:" << std::endl;
   }
