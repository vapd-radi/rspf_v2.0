...
//
//*************************************************************************
// $Id: rspfNormRgbVector.cpp 9094 2006-06-13 19:12:40Z dburken $
...
rspfNormRgbVector::rspfNormRgbVector(const rspfRgbVector& rgb)
{
...
rspfNormRgbVector::rspfNormRgbVector(const rspfJpegYCbCrVector& YCbCr)
{
   (*this) = YCbCr;
   
}

rspfNormRgbVector::rspfNormRgbVector(const rspfHsiVector& hsi)
{
   (*this)=hsi;
}

rspfNormRgbVector::rspfNormRgbVector(const rspfHsvVector& hsv)
{
   (*this) = hsv;
}

rspfNormRgbVector::rspfNormRgbVector(const rspfCmyVector& cmy)
{
...
const rspfNormRgbVector& rspfNormRgbVector::operator =(const rspfHsvVector& hsv)
{
...
const rspfNormRgbVector& rspfNormRgbVector::operator =(const rspfJpegYCbCrVector& YCbCr)
{
...
const rspfNormRgbVector& rspfNormRgbVector::operator =(const rspfHsiVector& hsi)
{
   rspf_float32 h = hsi.getH();
   rspf_float32 s = hsi.getS();
   rspf_float32 i = hsi.getI();
...
const rspfNormRgbVector& rspfNormRgbVector::operator =(const rspfCmyVector& cmy)
{
