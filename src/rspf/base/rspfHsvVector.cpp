...
//
//*************************************************************************
// $Id: rspfHsvVector.cpp 9963 2006-11-28 21:11:01Z gpotts $
#include <algorithm>
//using namespace std;
...
const float rspfHsvVector::RSPF_HSV_UNDEFINED = -1;
rspfHsvVector::rspfHsvVector(const rspfRgbVector& rgb)
{
   float r,g,b;
   ...
   if(v==x)
   {
      theBuf[0] = RSPF_HSV_UNDEFINED, // we really need to mark as undefined 
      theBuf[1] = 0;
      theBuf[2] = v;
   }
   else
...
const rspfHsvVector& rspfHsvVector::operator =(const rspfRgbVector& rgb)
{
   float r,g,b;
