...
RTTI_DEF1(rspfTransCylEquAreaProjection, "rspfTransCylEquAreaProjection", rspfMapProjection)
/***************************************************************************/
/*
 *                              DEFINES
 */
...
rspfTransCylEquAreaProjection::rspfTransCylEquAreaProjection(const rspfEllipsoid& ellipsoid,
...
void rspfTransCylEquAreaProjection::setFalseEasting(double falseEasting)
{
   Tcea_False_Easting = falseEasting;
   
   update();
}
void rspfTransCylEquAreaProjection::setFalseNorthing(double falseNorthing)
{
   Tcea_False_Northing = falseNorthing;
   
   update();
}
void rspfTransCylEquAreaProjection::setFalseEastingNorthing(double falseEasting,
                                                      double falseNorthing)
{
   Tcea_False_Easting  = falseEasting;
   Tcea_False_Northing = falseNorthing;
...
void rspfTransCylEquAreaProjection::setScaleFactor(double scaleFactor)
{
   Tcea_Scale_Factor = scaleFactor;
   
   update();
}
void rspfTransCylEquAreaProjection::setParameters(double falseEasting,
                                                   double falseNorthing,
                                                   double scaleFactor)
{
   Tcea_False_Easting  = falseEasting;
...
void rspfTransCylEquAreaProjection::setDefaults()
{
...
void rspfTransCylEquAreaProjection::update()
{  
...
rspfGpt rspfTransCylEquAreaProjection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfGpt rspfTransCylEquAreaProjection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat = 0.0;
   double lon = 0.0;
...
bool rspfTransCylEquAreaProjection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   kwl.add(prefix,
...
bool rspfTransCylEquAreaProjection::loadState(const rspfKeywordlist& kwl,
                                               const char* prefix)
{
   ...
   setDefaults();
   if(rspfString(type) == STATIC_TYPE_NAME(rspfTransCylEquAreaProjection))
   {
      Tcea_False_Easting  = theFalseEastingNorthing.x;
      Tcea_False_Northing = theFalseEastingNorthing.y;
      if(scaleFactor)
      {
         Tcea_Scale_Factor = rspfString(scaleFactor).toDouble();
      }
   }
...
long rspfTransCylEquAreaProjection::Set_Trans_Cyl_Eq_Area_Parameters(double a,
                                                                      double f,
...
void rspfTransCylEquAreaProjection::Get_Trans_Cyl_Eq_Area_Parameters(double *a,
                                                                      double *f,
                                                                      double *Origin_Latitude,
                                                                      double *Central_Meridian,
                                                                      double *False_Easting,
...
long rspfTransCylEquAreaProjection::Convert_Geodetic_To_Trans_Cyl_Eq_Area (double Latitude,
                                                                            double Longitude,
                                                                            double *Easting,
...
long rspfTransCylEquAreaProjection::Convert_Trans_Cyl_Eq_Area_To_Geodetic(double Easting,
                                                                           double Northing,
                                                                           double *Latitude,
...
bool rspfTransCylEquAreaProjection::operator==(const rspfProjection& proj) const
{
   if (!rspfMapProjection::operator==(proj))
      return false;
   rspfTransCylEquAreaProjection* p = PTR_CAST(rspfTransCylEquAreaProjection, &proj);
   if (!p) return false;
   if (!rspf::almostEqual(Tcea_Scale_Factor,p->Tcea_Scale_Factor)) return false;
   return true;
}
