...
RTTI_DEF1(rspfSinusoidalProjection, "rspfSinusoidalProjection", rspfMapProjection)
/***************************************************************************/
/*
 *                              DEFINES
 */
 ...
 *                              FUNCTIONS     
 */
rspfSinusoidalProjection::rspfSinusoidalProjection(const rspfEllipsoid& ellipsoid,
...
void rspfSinusoidalProjection::update()
{   
...
void rspfSinusoidalProjection::setFalseEasting(double falseEasting)
{
   Sinu_False_Easting = falseEasting;
   
   update();
}
void rspfSinusoidalProjection::setFalseNorthing(double falseNorthing)
{
   Sinu_False_Northing = falseNorthing;
   
   update();
}
void rspfSinusoidalProjection::setDefaults()
{
   Sinu_Max_Easting    = 20037509.0;
   Sinu_Min_Easting    = -20037509.0;
   Sinu_Delta_Northing = 10001966.0;
...
void rspfSinusoidalProjection::setCentralMeridian(double centralMeridian)
{
  Sinu_Origin_Long = centralMeridian;
  update();
}
void rspfSinusoidalProjection::setFalseEastingNorthing(double falseEasting,
                                                        double falseNorthing)
{
   Sinu_False_Easting  = falseEasting;
   Sinu_False_Northing = falseNorthing;
...
rspfGpt rspfSinusoidalProjection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfGpt rspfSinusoidalProjection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfDpt rspfSinusoidalProjection::forward(const rspfGpt &latLon)const
{
   double easting  = 0.0;
   double northing = 0.0;
   rspfGpt gpt = latLon;
...
bool rspfSinusoidalProjection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   return rspfMapProjection::saveState(kwl, prefix);
}
bool rspfSinusoidalProjection::loadState(const rspfKeywordlist& kwl,
                                          const char* prefix)
{
   ...
   setDefaults();
   if(rspfString(type) == STATIC_TYPE_NAME(rspfSinusoidalProjection))
   {
 ...
 *                              FUNCTIONS     
 */
long rspfSinusoidalProjection::Set_Sinusoidal_Parameters(double a,
                                                          double f,
...
void rspfSinusoidalProjection::Get_Sinusoidal_Parameters(double *a,
                                                          double *f,
                                                          double *Central_Meridian,
                                                          double *False_Easting,
...
long rspfSinusoidalProjection::Convert_Geodetic_To_Sinusoidal (double Latitude,
                                                                double Longitude,
                                                                double *Easting,
...
bool rspfSinusoidalProjection::operator==(const rspfProjection& proj) const
{
   if (!rspfMapProjection::operator==(proj))
      return false;
   rspfSinusoidalProjection* p = PTR_CAST(rspfSinusoidalProjection, &proj);
   if (!p) return false;
   if (!rspf::almostEqual(Sinu_Origin_Long,p->Sinu_Origin_Long)) return false;
   return true;
}
