...
RTTI_DEF1(rspfEckert4Projection, "rspfEckert4Projection", rspfMapProjection)
/***************************************************************************/
/*
 *                               DEFINES
 */
...
rspfEckert4Projection::rspfEckert4Projection(const rspfEllipsoid& ellipsoid,
...
void rspfEckert4Projection::update()
{   
...
rspfGpt rspfEckert4Projection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat  = 0.0;
   double lon = 0.0;
...
rspfGpt rspfEckert4Projection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat  = 0.0;
   double lon = 0.0;
...
rspfDpt rspfEckert4Projection::forward(const rspfGpt &latLon)const
{
   double easting  = 0.0;
   double northing = 0.0;
   rspfGpt gpt = latLon;
...
void rspfEckert4Projection::setFalseEasting(double falseEasting)
{
   Eck4_False_Easting = falseEasting;
   update();
}
void rspfEckert4Projection::setFalseNorthing(double falseNorthing)
{
   Eck4_False_Northing = falseNorthing;
   update();
}
void rspfEckert4Projection::setFalseEastingNorthing(double falseEasting,
                                                        double falseNorthing)
{
   Eck4_False_Easting = falseEasting;
   Eck4_False_Northing = falseNorthing;
...
void rspfEckert4Projection::setDefaults()
{
   Eck4_Delta_Northing  = 8451144.0;
   Eck4_Max_Easting     = 16902288.0;
   Eck4_Min_Easting     = -16902288.0;
...
bool rspfEckert4Projection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   return rspfMapProjection::saveState(kwl, prefix);
}
bool rspfEckert4Projection::loadState(const rspfKeywordlist& kwl, const char* prefix)
{
   ...
   if(rspfString(type) == STATIC_TYPE_NAME(rspfEckert4Projection))
   {
 ...
 *                              FUNCTIONS
 */
long rspfEckert4Projection::Set_Eckert4_Parameters(double a,
                                                    double f,                
...
void rspfEckert4Projection::Get_Eckert4_Parameters(double *a,
                                                    double *f,
                                                    double *Central_Meridian,
                                                    double *False_Easting,
...
long rspfEckert4Projection::Convert_Geodetic_To_Eckert4 (double Latitude,
                                                          double Longitude,
                                                          double *Easting,
...
long rspfEckert4Projection::Convert_Eckert4_To_Geodetic(double Easting,
                                                         double Northing,
                                                         double *Latitude,
