...
RTTI_DEF1(rspfOrthoGraphicProjection, "rspfOrthoGraphicProjection", rspfMapProjection)
/***************************************************************************/
/*
 *                              DEFINES
 */
...
rspfOrthoGraphicProjection::rspfOrthoGraphicProjection(const rspfEllipsoid& ellipsoid,
...
void rspfOrthoGraphicProjection::update()
{
...
void rspfOrthoGraphicProjection::setFalseEasting(double falseEasting)
{
   Orth_False_Easting = falseEasting;
   update();
}
void rspfOrthoGraphicProjection::setFalseNorthing(double falseNorthing)
{
   Orth_False_Northing = falseNorthing;
   update();
}
void rspfOrthoGraphicProjection::setDefaults()
{
   Orth_False_Easting  = 0.0;
   Orth_False_Northing = 0.0;
}
void rspfOrthoGraphicProjection::setFalseEastingNorthing(double falseEasting,
                                                      double falseNorthing)
{
   Orth_False_Easting  = falseEasting;
   Orth_False_Northing = falseNorthing;
...
void rspfOrthoGraphicProjection::getGroundClipPoints(rspfGeoPolygon& gpts)const
{
   
   gpts.addPoint(rspfGpt(theOrigin.latd(),
                          theOrigin.lond()-90.0,
                          0.0,
                          theDatum));
   gpts.addPoint(rspfGpt(theOrigin.latd()+90.0,
                          theOrigin.lond(),
                          0.0,
                          theDatum));
   gpts.addPoint(rspfGpt(theOrigin.latd(),
...
rspfGpt rspfOrthoGraphicProjection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat = 0.0;
   double lon = 0.0;
   rspfGpt result;
...
rspfGpt rspfOrthoGraphicProjection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat = 0.0;
   double lon = 0.0;
   rspfGpt result;
...
rspfDpt rspfOrthoGraphicProjection::forward(const rspfGpt &latLon)const
{
   double easting  = 0.0;
   double northing = 0.0;
   rspfGpt gpt = latLon;
   ...
   {
      result = rspfDpt(easting, northing);
   }
   else
   {
      result.makeNan();
...
bool rspfOrthoGraphicProjection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   return rspfMapProjection::saveState(kwl, prefix);
}
bool rspfOrthoGraphicProjection::loadState(const rspfKeywordlist& kwl,
                                            const char* prefix)
{
   ...
   setDefaults();
   if(rspfString(type) == STATIC_TYPE_NAME(rspfOrthoGraphicProjection))
   {
 ...
 *                              FUNCTIONS
 */
long rspfOrthoGraphicProjection::Set_Orthographic_Parameters(double a,
                                                              double f,
...
void rspfOrthoGraphicProjection::Get_Orthographic_Parameters(double *a,
                                                              double *f,
                                                              double *Origin_Latitude,
                                                              double *Central_Meridian,
                                                              double *False_Easting,
...
long rspfOrthoGraphicProjection::Convert_Geodetic_To_Orthographic (double Latitude,
                                                                    double Longitude,
                                                                    double *Easting,
...
long rspfOrthoGraphicProjection::Convert_Orthographic_To_Geodetic(double Easting,
                                                                   double Northing,
                                                                   double *Latitude,
