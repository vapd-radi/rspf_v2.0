...
RTTI_DEF1(rspfAzimEquDistProjection,"rspfAzimEquDistProjection", rspfMapProjection)
   
rspfAzimEquDistProjection::rspfAzimEquDistProjection(const rspfEllipsoid& ellipsoid,
                                                       const rspfGpt& origin)
   :rspfMapProjection(ellipsoid,
                       origin)
{
   setDefaults();
}
...
void rspfAzimEquDistProjection::update()
{
...
rspfGpt rspfAzimEquDistProjection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat, lon;
...
rspfGpt rspfAzimEquDistProjection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat, lon;
   Convert_Azimuthal_Equidistant_To_Geodetic(eastingNorthing.x,
                                             eastingNorthing.y,
...
rspfDpt rspfAzimEquDistProjection::forward(const rspfGpt &latLon)const
{
   double easting  = 0.0;
   double northing = 0.0;
   rspfGpt gpt = latLon;
...
void rspfAzimEquDistProjection::setFalseEasting(double falseEasting)
{
   Azeq_False_Easting = falseEasting;
   update();
}
void rspfAzimEquDistProjection::setFalseNorthing(double falseNorthing)
{
   Azeq_False_Northing = falseNorthing;
   
   update();
}
void rspfAzimEquDistProjection::setFalseEastingNorthing(double falseEasting,
                                                         double falseNorthing)
{
   Azeq_False_Easting = falseEasting;
   Azeq_False_Northing = falseNorthing;
...
void rspfAzimEquDistProjection::setDefaults()
{
   Azeq_False_Easting  = 0.0;
   Azeq_False_Northing = 0.0;
   update();
}
bool rspfAzimEquDistProjection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   return rspfMapProjection::saveState(kwl, prefix);
}
bool rspfAzimEquDistProjection::loadState(const rspfKeywordlist& kwl, const char* prefix)
{
   bool flag = rspfMapProjection::loadState(kwl, prefix);
   const char* type          = kwl.find(prefix, rspfKeywordNames::TYPE_KW);
   setDefaults();
   if(rspfString(type) == STATIC_TYPE_NAME(rspfAzimEquDistProjection))
   {
...
long rspfAzimEquDistProjection::Set_Azimuthal_Equidistant_Parameters(double a,
                                                                      double f,
...
void rspfAzimEquDistProjection::Get_Azimuthal_Equidistant_Parameters(double *a,
                                                                      double *f,
                                                                      double *Origin_Latitude,
                                                                      double *Central_Meridian,
                                                                      double *False_Easting,
...
long rspfAzimEquDistProjection::Convert_Geodetic_To_Azimuthal_Equidistant (double Latitude,
                                                                            double Longitude,
                                                                            double *Easting,
...
long rspfAzimEquDistProjection::Convert_Azimuthal_Equidistant_To_Geodetic(double Easting,
                                                                           double Northing,
                                                                           double *Latitude,
