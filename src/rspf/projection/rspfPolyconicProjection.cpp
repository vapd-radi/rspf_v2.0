...
RTTI_DEF1(rspfPolyconicProjection, "rspfPolyconicProjection", rspfMapProjection)
/***************************************************************************/
/*
 *                              DEFINES
 */
...
rspfPolyconicProjection::rspfPolyconicProjection(const rspfEllipsoid& ellipsoid,
...
void rspfPolyconicProjection::update()
{   
...
void rspfPolyconicProjection::setFalseEasting(double falseEasting)
{
   Poly_False_Easting = falseEasting;
   
   update();
}
void rspfPolyconicProjection::setFalseNorthing(double falseNorthing)
{
   Poly_False_Northing = falseNorthing;
   
   update();
}
void rspfPolyconicProjection::setDefaults()
{
...
void rspfPolyconicProjection::setFalseEastingNorthing(double falseEasting,
                                                      double falseNorthing)
{
   Poly_False_Easting  = falseEasting;
   Poly_False_Northing = falseNorthing;
...
rspfGpt rspfPolyconicProjection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfGpt rspfPolyconicProjection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat = 0.0;
   double lon = 0.0;
   Convert_Polyconic_To_Geodetic(eastingNorthing.x,
...
rspfDpt rspfPolyconicProjection::forward(const rspfGpt &latLon)const
{
   double easting  = 0.0;
   double northing = 0.0;
   rspfGpt gpt = latLon;
...
bool rspfPolyconicProjection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   return rspfMapProjection::saveState(kwl, prefix);
}
bool rspfPolyconicProjection::loadState(const rspfKeywordlist& kwl,
                                         const char* prefix)
{
   ...
   setDefaults();
   if(rspfString(type) == STATIC_TYPE_NAME(rspfPolyconicProjection))
   {
 ...
 *                              FUNCTIONS     
 */
long rspfPolyconicProjection::Set_Polyconic_Parameters(double a,
                                                        double f,
...
void rspfPolyconicProjection::Get_Polyconic_Parameters(double *a,
                                                        double *f,
                                                        double *Origin_Latitude,
                                                        double *Central_Meridian,
                                                        double *False_Easting,
...
long rspfPolyconicProjection::Convert_Geodetic_To_Polyconic (double Latitude,
                                                              double Longitude,
                                                              double *Easting,
