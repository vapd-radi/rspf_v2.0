...
RTTI_DEF1(rspfCassiniProjection, "rspfCassiniProjection", rspfMapProjection)
/***************************************************************************/
/*
 *                               DEFINES
 */
...
rspfCassiniProjection::rspfCassiniProjection(const rspfEllipsoid& ellipsoid,
...
void rspfCassiniProjection::update()
{      
...
void rspfCassiniProjection::setFalseEasting(double falseEasting)
{
   Cass_False_Easting = falseEasting;
   update();
}
void rspfCassiniProjection::setFalseNorthing(double falseNorthing)
{
   Cass_False_Northing = falseNorthing;
   update();
}
void rspfCassiniProjection::setFalseEastingNorthing(double falseEasting,
...
void rspfCassiniProjection::setDefaults()
{
   Cass_Min_Easting    = -20037508.4;
   Cass_Max_Easting    = 20037508.4;
   Cass_Min_Northing   = -56575846.0;
...
rspfGpt rspfCassiniProjection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfGpt rspfCassiniProjection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfDpt rspfCassiniProjection::forward(const rspfGpt &latLon)const
{
   double easting  = 0.0;
   double northing = 0.0;
   rspfGpt gpt = latLon;
...
bool rspfCassiniProjection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   return rspfMapProjection::saveState(kwl, prefix);
}
bool rspfCassiniProjection::loadState(const rspfKeywordlist& kwl,
                                       const char* prefix)
{
   ...
   if(rspfString(type) == STATIC_TYPE_NAME(rspfCassiniProjection))
   {
 ...
 *                              FUNCTIONS     
 */
long rspfCassiniProjection::Set_Cassini_Parameters(double a,
                                                    double f,
...
void rspfCassiniProjection::Get_Cassini_Parameters(double *a,
                                                    double *f,
                                                    double *Origin_Latitude,
                                                    double *Central_Meridian,
                                                    double *False_Easting,
...
long rspfCassiniProjection::Convert_Geodetic_To_Cassini (double Latitude,
                                                          double Longitude,
                                                          double *Easting,
...
long rspfCassiniProjection::Convert_Cassini_To_Geodetic(double Easting,
                                                         double Northing,
                                                         double *Latitude,
