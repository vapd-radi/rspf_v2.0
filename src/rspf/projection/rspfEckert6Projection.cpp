...
RTTI_DEF1(rspfEckert6Projection, "rspfEckert6Projection", rspfMapProjection)
...
rspfEckert6Projection::rspfEckert6Projection(const rspfEllipsoid& ellipsoid,
...
void rspfEckert6Projection::update()
{
...
rspfGpt rspfEckert6Projection::inverse_do(const rspfDpt &eastingNorthing,const rspfGpt &latLon)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfGpt rspfEckert6Projection::inverse(const rspfDpt &eastingNorthing)const
{
   double lat = 0.0;
   double lon = 0.0;
...
rspfDpt rspfEckert6Projection::forward(const rspfGpt &latLon)const
{
   double easting  = 0.0;
   double northing = 0.0;
   rspfGpt gpt = latLon;
...
void rspfEckert6Projection::setFalseEasting(double falseEasting)
{
   Eck6_False_Easting = falseEasting;
   update();
}
void rspfEckert6Projection::setFalseNorthing(double falseNorthing)
{
   Eck6_False_Northing = falseNorthing;
   update();
}
void rspfEckert6Projection::setFalseEastingNorthing(double falseEasting,
                                                        double falseNorthing)
{
   Eck6_False_Easting = falseEasting;
   Eck6_False_Northing = falseNorthing;
...
void rspfEckert6Projection::setDefaults()
{
   Eck6_Delta_Northing  = 8451144.0;
   Eck6_Max_Easting     = 16902288.0;
   Eck6_Min_Easting     = -16902288.0;
...
void rspfEckert6Projection::setCentralMeridian(double centralMeridian)
{
  Eck6_Origin_Long = centralMeridian;
  update();
}
bool rspfEckert6Projection::saveState(rspfKeywordlist& kwl, const char* prefix) const
{
   return rspfMapProjection::saveState(kwl, prefix);
}
bool rspfEckert6Projection::loadState(const rspfKeywordlist& kwl, const char* prefix)
{
   ...
   if(rspfString(type) == STATIC_TYPE_NAME(rspfEckert6Projection))
   {
 ...
 *                              FUNCTIONS
 */
long rspfEckert6Projection::Set_Eckert6_Parameters(double a,
                                                    double f,
...
void rspfEckert6Projection::Get_Eckert6_Parameters(double *a,
                                                    double *f,
                                                    double *Central_Meridian,
                                                    double *False_Easting,
...
long rspfEckert6Projection::Convert_Geodetic_To_Eckert6 (double Latitude,
                                                          double Longitude,
                                                          double *Easting,
...
long rspfEckert6Projection::Convert_Eckert6_To_Geodetic(double Easting,
                                                         double Northing,
                                                         double *Latitude,
