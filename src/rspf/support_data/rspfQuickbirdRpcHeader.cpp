...
//
//----------------------------------------------------------------------------
// $Id: rspfQuickbirdRpcHeader.cpp 9094 2006-06-13 19:12:40Z dburken $
...
rspfQuickbirdRpcHeader::rspfQuickbirdRpcHeader()
{
}

bool rspfQuickbirdRpcHeader::open(const rspfFilename& file)
{
   theFilename = file;
...
bool rspfQuickbirdRpcHeader::readCoeff(std::istream& in,
...
bool rspfQuickbirdRpcHeader::parseNameValue(const rspfString& line)
{
   bool result = true;
