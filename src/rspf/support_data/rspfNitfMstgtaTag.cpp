...
RTTI_DEF1(rspfNitfMstgtaTag, "rspfNitfMstgtaTag", rspfNitfRegisteredTag);

rspfNitfMstgtaTag::rspfNitfMstgtaTag()
   : rspfNitfRegisteredTag(std::string("MSTGTA"), 101)
{
   clearFields();
}
...
void rspfNitfMstgtaTag::parseStream(std::istream& in)
{
   clearFields();
...
void rspfNitfMstgtaTag::writeStream(std::ostream& out)
{
...
void rspfNitfMstgtaTag::clearFields()
{
...
std::ostream& rspfNitfMstgtaTag::print(
