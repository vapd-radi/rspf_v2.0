...
RTTI_DEF1(rspfNitfAcftbTag, "rspfNitfAcftbTag", rspfNitfRegisteredTag);

rspfNitfAcftbTag::rspfNitfAcftbTag()
   : rspfNitfRegisteredTag(std::string("ACFTB"), CEL_SIZE)
{
   clearFields();
}
...
void rspfNitfAcftbTag::parseStream(std::istream& in)
{
   clearFields();
...
void rspfNitfAcftbTag::writeStream(std::ostream& out)
{
...
void rspfNitfAcftbTag::clearFields()
{
...
rspfString rspfNitfAcftbTag::getFocalLength()const
{
   return rspfString(theFocalLength);
}

rspfString rspfNitfAcftbTag::getColumnSpacing()const
{
   return rspfString(theColSpacing);
}

rspfString rspfNitfAcftbTag::getColumnSpacingUnits()const
{
   return rspfString(theColSpacingUnits);
}

rspfString rspfNitfAcftbTag::getRowSpacing()const
{
   return rspfString(theRowSpacing);
}

rspfString rspfNitfAcftbTag::getRowSpacingUnits()const
{
   return rspfString(theRowSpacingUnits);
}


std::ostream& rspfNitfAcftbTag::print(
