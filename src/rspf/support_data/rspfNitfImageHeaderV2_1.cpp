...
// 
//********************************************************************
// $Id: rspfNitfImageHeaderV2_1.cpp 21518 2012-08-22 21:15:56Z dburken $
#include <sstream>
#include <iomanip>
...
RTTI_DEF1(rspfNitfImageHeaderV2_1,
          "rspfNitfImageHeaderV2_1",
          rspfNitfImageHeaderV2_X)

const rspfString rspfNitfImageHeaderV2_1::ISCLSY_KW = "isclsy";
const rspfString rspfNitfImageHeaderV2_1::ISCODE_KW = "iscode";
const rspfString rspfNitfImageHeaderV2_1::ISCTLH_KW = "isctlh";
const rspfString rspfNitfImageHeaderV2_1::ISREL_KW = "isrel";
const rspfString rspfNitfImageHeaderV2_1::ISDCTP_KW = "isdctp";
const rspfString rspfNitfImageHeaderV2_1::ISDCDT_KW = "isdcdt";
const rspfString rspfNitfImageHeaderV2_1::ISDCXM_KW = "isdcxm";
const rspfString rspfNitfImageHeaderV2_1::ISDG_KW = "isdg";
const rspfString rspfNitfImageHeaderV2_1::ISDGDT_KW = "isdgdt";
const rspfString rspfNitfImageHeaderV2_1::ISCLTX_KW = "iscltx";
const rspfString rspfNitfImageHeaderV2_1::ISCATP_KW = "iscatp";
const rspfString rspfNitfImageHeaderV2_1::ISCAUT_KW = "iscaut";
const rspfString rspfNitfImageHeaderV2_1::ISCRSN_KW = "iscrsn";
const rspfString rspfNitfImageHeaderV2_1::ISSRDT_KW = "issrdt";
const rspfString rspfNitfImageHeaderV2_1::ISCTLN_KW = "isctln";
const rspfString rspfNitfImageHeaderV2_1::XBANDS_KW = "xbands";

static const
rspfTrace traceDebug(rspfString("rspfNitfImageHeaderV2_1:debug"));

rspfNitfImageHeaderV2_1::rspfNitfImageHeaderV2_1()
{
   clearFields();
}
rspfNitfImageHeaderV2_1::~rspfNitfImageHeaderV2_1()
...
void rspfNitfImageHeaderV2_1::parseStream(std::istream &in)
{
   if (!in)
   {
      return;
   ...
   rspf_int32 numberOfComments = rspfString(theNumberOfComments).toInt32();
   ...
   // NC (No compression)
   rspfString temp = theCompression;
   if((temp != "NC") &&
      (temp != "NM"))
   {
   ...
   rspf_int32 numberOfBands = rspfString(theNumberOfBands).toInt32();
   if (numberOfBands == 0)
   {
      in.read(theNumberOfMultispectralBands, 5);
      numberOfBands = rspfString(theNumberOfMultispectralBands).toInt32();
   }
   theImageBands.clear();
   theImageBands.resize(numberOfBands);
   for (rspf_int32 band = 0; band < numberOfBands; ++band)
   {
      theImageBands[band] = new rspfNitfImageBandV2_1;
   ...
   std::streampos userDefinedDataLen
      = rspfString(theUserDefinedImageDataLength).toInt32();
   ...
   std::streampos extSubHeadLen = rspfString(theExtendedSubheaderDataLen).toInt32();
   start   = in.tellg();
   current = in.tellg();
   if(extSubHeadLen > 0)
   {
   ...
   rspfString compressionType = theCompression;
   ...
   if((compressionType == "NM")||
      ...
      (compressionType == "C4"))
   {
      rspf_uint64 locationBefore = in.tellg();
      ...
      if(theBlockMaskRecordLength>0)
      {
         ...
         rspf_uint32 *blockRead = new rspf_uint32[totalNumber];
         rspf_uint32 idx = 0;
      ...
      {
         rspfRefPtr<rspfNitfVqCompressionHeader> compressionHeader = new rspfNitfVqCompressionHeader;
      ...
      rspf_uint64 delta = (rspf_uint64)in.tellg() - locationBefore;
...
void rspfNitfImageHeaderV2_1::writeStream(std::ostream &out)
{
   out.write(theType, 2);
   ...
   rspfString compressionTest = theCompression;
   ...
   if(rspfString(theNumberOfBands).toInt32() == 0)
   {
   ...
   if(rspfString(theUserDefinedImageDataLength).toInt32() > 0)
   {
   ...
   else
   {
      ...
      else
      {
         rspfNotify(rspfNotifyLevel_WARN)
            << "WARNING rspfNitfFileHeaderV2_1::writeStream: Only support writing of total tag length < 99999" << std::endl;
      }
   }
}

std::ostream& rspfNitfImageHeaderV2_1::print(std::ostream& out,
...
bool rspfNitfImageHeaderV2_1::saveState(rspfKeywordlist& kwl, const rspfString& prefix)const
{
   rspfNitfImageHeaderV2_X::saveState(kwl, prefix);
...
bool rspfNitfImageHeaderV2_1::loadState(const rspfKeywordlist& kwl, const char* prefix)
{
   ...
   if ( lookup )
   {
      setSecurityClassificationSystem( rspfString(lookup) );
   }
   ...
   if ( lookup )
   {
      setDeclassificationExempt( rspfString(lookup) );
   }
   ...
   if ( lookup )
   {
      setDowngradeDate( rspfString(lookup) );
   }
   ...
   return rspfNitfImageHeaderV2_X::loadState(kwl, prefix);
}

bool rspfNitfImageHeaderV2_1::isCompressed()const
{
   rspfString temp = theCompression;
   temp = temp.trim();
...
bool rspfNitfImageHeaderV2_1::isEncrypted()const
{
   return (theEncryption[0] == '1');
}

rspf_int32 rspfNitfImageHeaderV2_1::getNumberOfBands()const
{
   if(theNumberOfBands[0] == '0')
   {
      return rspfString(theNumberOfMultispectralBands).toInt32();
   }
   else
   {
      return rspfString(theNumberOfBands).toInt32();
   }
}

rspf_int32 rspfNitfImageHeaderV2_1::getNumberOfRows()const
{
   return rspfString(theSignificantRows).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_1::getNumberOfCols()const
{
   return rspfString(theSignificantCols).toInt32();
}

rspfString rspfNitfImageHeaderV2_1::getImageId()const
{
   return theImageId;
}

rspf_int32 rspfNitfImageHeaderV2_1::getBitsPerPixelPerBand()const
{
   return rspfString(theNumberOfBitsPerPixelPerBand).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_1::getActualBitsPerPixelPerBand()const
{
   return rspfString(theActualBitsPerPixelPerBand).toInt32();
}

rspfString rspfNitfImageHeaderV2_1::getIMode() const
{
   return rspfString(theImageMode).trim();
}

rspfString rspfNitfImageHeaderV2_1::getSecurityClassification()const
{
   return theSecurityClassification;
}

rspfString  rspfNitfImageHeaderV2_1::getImageDateAndTime() const
{
   return rspfString(theDateTime);
}

rspfString rspfNitfImageHeaderV2_1::getAcquisitionDateMonthDayYear(rspf_uint8 separationChar)const
{
   rspfString result;

   result += rspfString(theDateTime + 4,
                         theDateTime + 6);
   result += rspfString(separationChar);
   result += rspfString(theDateTime + 6,
                         theDateTime + 8);
   result += rspfString(separationChar);
   result += rspfString(theDateTime,
                         theDateTime + 4);
   
   return result;
}

rspfString rspfNitfImageHeaderV2_1::getCategory()const
{
   return theCategory;
}

rspfString rspfNitfImageHeaderV2_1::getImageSource()const
{
   return theImageSource;
}

rspfString rspfNitfImageHeaderV2_1::getRepresentation()const
{
   return theRepresentation;
}

rspfString rspfNitfImageHeaderV2_1::getCoordinateSystem()const
{
   return theCoordinateSystem;
}

bool rspfNitfImageHeaderV2_1::hasBlockMaskRecords()const
{
   return (theBlockMaskRecords.size() > 0);
}

bool rspfNitfImageHeaderV2_1::hasPadPixelMaskRecords()const
{
   return (thePadPixelMaskRecords.size()>0);
}

bool rspfNitfImageHeaderV2_1::hasTransparentCode()const
{
   return (theTransparentOutputPixelCodeLength > 0);
}

rspf_uint32 rspfNitfImageHeaderV2_1::getTransparentCode()const
{
   return thePadOutputPixelCode;
}

rspf_uint32 rspfNitfImageHeaderV2_1::getBlockMaskRecordOffset(rspf_uint32 blockNumber,
                                                                rspf_uint32 bandNumber)const
{
   rspf_uint32 maxBlock = getNumberOfBlocksPerRow()*getNumberOfBlocksPerCol();
   rspf_uint32 result = 0xffffffff;
      ...
      (blockNumber < maxBlock))
   {
      if(theImageMode[0] == 'S')
      {
         if(bandNumber < (rspf_uint32)getNumberOfBands())
         {
...
rspf_uint32 rspfNitfImageHeaderV2_1::getPadPixelMaskRecordOffset(rspf_uint32 blockNumber,
                                                                   rspf_uint32 bandNumber)const
{
   rspf_uint32 maxBlock = getNumberOfBlocksPerRow()*getNumberOfBlocksPerCol();
   rspf_uint32 result = 0xffffffff;
...
void rspfNitfImageHeaderV2_1::clearFields()
{
   memcpy(theType, "IM", 2);
...
rspf_int32 rspfNitfImageHeaderV2_1::getNumberOfBlocksPerRow()const
{
   return rspfString(theNumberOfBlocksPerRow).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_1::getNumberOfBlocksPerCol()const
{
   return rspfString(theNumberOfBlocksPerCol).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_1::getNumberOfPixelsPerBlockHoriz()const
{
 //  return rspfString(theNumberOfPixelsPerBlockHoriz).toInt32();
   rspf_int32 rval = rspfString(theNumberOfPixelsPerBlockHoriz).toInt32();
...
rspf_int32 rspfNitfImageHeaderV2_1::getNumberOfPixelsPerBlockVert()const
{
//   return rspfString(theNumberOfPixelsPerBlockVert).toInt32();
   rspf_int32 rval = rspfString(theNumberOfPixelsPerBlockVert).toInt32();
...
rspfString rspfNitfImageHeaderV2_1::getPixelValueType()const
{
   return rspfString(thePixelValueType).trim();
}

void rspfNitfImageHeaderV2_1::setNumberOfBands(rspf_uint32 nbands)
{
   std::ostringstream out;
...
void rspfNitfImageHeaderV2_1::setBandInfo(rspf_uint32 idx,
                                           const rspfNitfImageBandV2_1& info)
{
   if(idx < theImageBands.size())
   {
      if(!theImageBands[idx].valid())
      {
         theImageBands[idx] = new rspfNitfImageBandV2_1;
      }
      (*theImageBands[idx]) = info;
   }
}

void rspfNitfImageHeaderV2_1::setNumberOfRows(rspf_uint32 rows)
{
   std::ostringstream out;
   if(rows > 99999999) rows = 99999999;
   
   out << rows;
   rspfNitfCommon::setField(theSignificantRows, out.str(), 8, ios::right, '0');
}

void rspfNitfImageHeaderV2_1::setNumberOfCols(rspf_uint32 cols)
{
   std::ostringstream out;
   if(cols > 99999999) cols = 99999999;

   out << cols;
   rspfNitfCommon::setField(theSignificantCols, out.str(), 8, ios::right, '0');
}

void rspfNitfImageHeaderV2_1::setSecurityClassificationSystem(const rspfString& value)
{
   rspfNitfCommon::setField(theSecurityClassificationSys, value, 2);
}

void rspfNitfImageHeaderV2_1::setCodewords(const rspfString& value)
{
   rspfNitfCommon::setField(theCodewords, value, 11);
}

void rspfNitfImageHeaderV2_1::setControlAndHandling(const rspfString& value)
{
   rspfNitfCommon::setField(theControlAndHandling, value, 2);
}

void rspfNitfImageHeaderV2_1::setReleasingInstructions(const rspfString& value)
{
   rspfNitfCommon::setField(theReleasingInstructions, value, 20);
}

void rspfNitfImageHeaderV2_1::setDeclassificationType(const rspfString& value)
{
   rspfNitfCommon::setField(theDeclassificationType, value, 2);
}

void rspfNitfImageHeaderV2_1::setDeclassificationDate(const rspfString& value)
{
   rspfNitfCommon::setField(theDeclassificationDate, value, 8);
}

void rspfNitfImageHeaderV2_1::setDeclassificationExempt(const rspfString& value)
{
   rspfNitfCommon::setField(theDeclassificationExempt, value, 4);
}

void rspfNitfImageHeaderV2_1::setDowngrade(const rspfString& value)
{
   rspfNitfCommon::setField(theDowngrade, value, 1);
}

void rspfNitfImageHeaderV2_1::setDowngradeDate(const rspfString& value)
{
   rspfNitfCommon::setField(theDowngradeDate, value, 8);
}

void rspfNitfImageHeaderV2_1::setClassificationText(const rspfString& value)
{
   rspfNitfCommon::setField(theClassificationText, value, 43);
}

void rspfNitfImageHeaderV2_1::setClassificationAuthorityType(const rspfString& value)
{
   rspfNitfCommon::setField(theClassificationAuthType, value, 1);
}

void rspfNitfImageHeaderV2_1::setClassificationAuthority(const rspfString& value)
{
   rspfNitfCommon::setField(theClassificationAuthority, value, 40);
}

void rspfNitfImageHeaderV2_1::setClassificationReason(const rspfString& value)
{
   rspfNitfCommon::setField(theClassificationReason, value, 1);
}

void rspfNitfImageHeaderV2_1::setSecuritySourceDate(const rspfString& value)
{
   rspfNitfCommon::setField(theSecuritySourceDate, value, 8);
}

void rspfNitfImageHeaderV2_1::setSecurityControlNumber(const rspfString& value)
{
   rspfNitfCommon::setField(theSecurityControlNumber, value, 15);
}

void rspfNitfImageHeaderV2_1::setImageMagnification(const rspfString& value)
{
   rspfNitfCommon::setField(theImageMagnification, value, 4);
}

void rspfNitfImageHeaderV2_1::setProperty(rspfRefPtr<rspfProperty> property)
{
   ...
   {
      rspfNitfImageHeaderV2_X::setProperty(property);
   }
}

rspfRefPtr<rspfProperty> rspfNitfImageHeaderV2_1::getProperty(const rspfString& name)const
{
   ...
   if(name == ISCLSY_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theSecurityClassificationSys).trim());
   }
   else if(name == ISCODE_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theCodewords).trim());
   }
   else if(name == ISCTLH_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theControlAndHandling).trim());
   }
   else if(name == ISREL_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theReleasingInstructions).trim());
   }
   else if(name == ISDCTP_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theDeclassificationType).trim());
   }
   else if(name == ISDCDT_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theDeclassificationDate).trim());
   }
   else if(name == ISDCXM_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theDeclassificationExempt).trim());
   }
   else if(name == ISDG_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theDowngrade).trim());
   }
   else if(name == ISDGDT_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theDowngradeDate).trim());
   }
   else if(name == ISCLTX_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theClassificationText).trim());
   }
   else if(name == ISCATP_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theClassificationAuthType).trim());
   }
   else if(name == ISCRSN_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theClassificationAuthority).trim());
   }
   else if(name == ISSRDT_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theSecuritySourceDate).trim());
   }
   else if(name == ISCTLN_KW)
   {
      property = new rspfStringProperty(name,
                                         rspfString(theSecurityControlNumber).trim());
   }
   else
   {
      return rspfNitfImageHeaderV2_X::getProperty(name);
   }
   
   return property;
}

void rspfNitfImageHeaderV2_1::getPropertyNames(std::vector<rspfString>& propertyNames)const
{
   rspfNitfImageHeaderV2_X::getPropertyNames(propertyNames);
...
const rspfRefPtr<rspfNitfCompressionHeader> rspfNitfImageHeaderV2_1::getCompressionHeader()const
{
   return theCompressionHeader;
}

const rspfRefPtr<rspfNitfImageBand> rspfNitfImageHeaderV2_1::getBandInformation(rspf_uint32 idx)const
{
   if(idx < theImageBands.size())
   {
      return (rspfNitfImageBand*)theImageBands[idx].get();
   }
