...
// 
//********************************************************************
// $Id: rspfNitfImageBandV2_0.cpp 16035 2009-12-03 21:32:27Z dburken $
...
rspfNitfImageBandV2_0::rspfNitfImageBandV2_0()
{
   clearFields();
}
...
void rspfNitfImageBandV2_0::parseStream(std::istream& in)
{
   ...
   {      
      ...
      long numberOfLuts = rspfString(theBandNumberOfLuts).toLong();
      ...
      if(numberOfLuts > 0)
      {
         ...
         rspf_uint32 numberOfLutsIndex = numberOfLuts;
         rspf_uint32 numberOfLutEntries = rspfString(theBandNumberOfLutEntries).toLong();
         rspf_uint32 idx = 0;

         while(idx < numberOfLutsIndex)
         {
            theLookupTables[idx] = new rspfNitfImageLutV2_0; 
...
void rspfNitfImageBandV2_0::writeStream(std::ostream& out)
{
   ...
   if(rspfString(theBandNumberOfLuts) > 0)
   {
      // lut output not supported currently
   }
}

std::ostream& rspfNitfImageBandV2_0::print(std::ostream& out,
...
rspf_uint32 rspfNitfImageBandV2_0::getNumberOfLuts()const
{
   return static_cast<rspf_uint32>(theLookupTables.size());
}

const rspfRefPtr<rspfNitfImageLut> rspfNitfImageBandV2_0::getLut(rspf_uint32 idx)const
{
...
rspfRefPtr<rspfNitfImageLut> rspfNitfImageBandV2_0::getLut(rspf_uint32 idx)
{
   if(idx < getNumberOfLuts())
   {
      return theLookupTables[idx];
...
rspfString rspfNitfImageBandV2_0::getBandRepresentation()const
{
   return rspfString(theBandRepresentation);
}

void rspfNitfImageBandV2_0::setBandRepresentation(const rspfString& rep)
{
...
rspfString rspfNitfImageBandV2_0::getBandSignificance()const
{
   return rspfString(theBandSignificance);
}

void rspfNitfImageBandV2_0::setBandSignificance(const rspfString& rep)
{
   std::ostringstream out;
...
void rspfNitfImageBandV2_0::clearFields()
{
...
void rspfNitfImageBandV2_0::printLookupTables(std::ostream& out)const
{
   std::vector<rspfRefPtr<rspfNitfImageLut> >::const_iterator tables;
