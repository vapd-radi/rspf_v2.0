...
// 
//********************************************************************
// $Id: rspfNitfGeoPositioningTag.cpp 22013 2012-12-19 17:37:20Z dburken $
...
RTTI_DEF1(rspfNitfGeoPositioningTag, "rspfNitfGeoPositioningTag", rspfNitfRegisteredTag);

rspfNitfGeoPositioningTag::rspfNitfGeoPositioningTag()
   : rspfNitfRegisteredTag(std::string("GEOPSB"),  443)
{
   clearFields();
}
...
void rspfNitfGeoPositioningTag::parseStream(std::istream& in)
{
   clearFields();
...
void rspfNitfGeoPositioningTag::writeStream(std::ostream& out)
{
   out.write(theType, 3);
...
void rspfNitfGeoPositioningTag::clearFields()
{
   memset(theType, ' ', 3);
...
std::ostream& rspfNitfGeoPositioningTag::print(
