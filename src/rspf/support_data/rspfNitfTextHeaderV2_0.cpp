...
// 
//********************************************************************
// $Id: rspfNitfTextHeaderV2_0.cpp 9094 2006-06-13 19:12:40Z dburken $
#include <rspf/support_data/rspfNitfTextHeaderV2_0.h>
#include <rspf/base/rspfString.h>
#include <cstring> // for memset
#include <istream>

RTTI_DEF1(rspfNitfTextHeaderV2_0, "rspfNitfTextHeaderV2_0", rspfNitfTextHeader)
   
rspfNitfTextHeaderV2_0::rspfNitfTextHeaderV2_0()
{
   clearFields();
}

void rspfNitfTextHeaderV2_0::parseStream(std::istream &in)
{
   if(in)
   {
      clearFields();
      ...
      if(rspfString(theTextSecurityDowngrade) == "999998")
      {
...
std::ostream& rspfNitfTextHeaderV2_0::print(std::ostream &out)const
{
...
void rspfNitfTextHeaderV2_0::clearFields()
{
