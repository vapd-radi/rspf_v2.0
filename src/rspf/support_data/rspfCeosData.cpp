...
static rspfTrace traceExec  ("rspfCeosData:exec");
static rspfTrace traceDebug ("rspfCeosData:debug");

static const rspfFilename   CEOS_VOL_DIR_FILENAME  = "vdf_dat.001";
static const rspfFilename   CEOS_LEADER_FILENAME   = "lea_01.001";
static const rspfFilename   CEOS_IMAGE_FILENAME    = "dat_01.001";
static const rspfFilename   CEOS_TRAILER_FILENAME  = "tra_01.001";


//******************************************************************************
//  CONSTRUCTOR: 
//******************************************************************************
rspfCeosData::rspfCeosData(const rspfFilename& volDirFile,
   ...
   :
      ...
      theRadiCompRec     (0)
{
   static const char MODULE[] = "rspfCeosData Constructor #1";
...
//******************************************************************************
//  CONSTRUCTOR: rspfCeosData(rspfFilename)
//  
//  Initializes given the image directory (assumes default filenames).
//  
//******************************************************************************
rspfCeosData::rspfCeosData(const rspfFilename& imageDir)
   :
      theErrorStatus   (OK),
      theVolDescRec    (0),
      theTextRec       (0),
      ...
      theRadiCompRec   (0)
{
   ...
   //***
   // Assign values to rspfFilename data members:
   //***
...
//******************************************************************************
// PUBLIC METHOD: rspfCeosData::dump(ostream&)
//  
//******************************************************************************
void rspfCeosData::dump(ostream& stream) const 
{
   static const char MODULE[] = "rspfCeosData::dump(ostream& stream)";
   if (traceExec())  CLOG << "entering..." << endl;

   stream << "\nDump of rspfCeosData Object -----------------------------" << endl;
   ...
   stream << "\nEnd of rspfCeosData Object Dump -------------------------" << endl;
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpVolDescRec()
//  
//******************************************************************************
void rspfCeosData::dumpVolDescRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpTextRec()
//  
//******************************************************************************
void rspfCeosData::dumpTextRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpImopDescRec()
//  
//******************************************************************************
void rspfCeosData::dumpImopDescRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpDataSetSumRec()
//  
//******************************************************************************
void rspfCeosData::dumpDataSetSumRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpQualSumRec()
//  
//******************************************************************************
void rspfCeosData::dumpQualSumRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpSdrHistRec()
//  
//******************************************************************************
void rspfCeosData::dumpSdrHistRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpPdr16HistRec()
//  
//******************************************************************************
void rspfCeosData::dumpPdr16HistRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpPdr8HistRec()
//  
//******************************************************************************
void rspfCeosData::dumpPdr8HistRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpProcParmRec()
//  
//******************************************************************************
void rspfCeosData::dumpProcParmRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpMapProjRec()
//  
//******************************************************************************
void rspfCeosData::dumpMapProjRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpPosDataRec()
//  
//******************************************************************************
void rspfCeosData::dumpPosDataRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpAttDataRec()
//  
//******************************************************************************
void rspfCeosData::dumpAttDataRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpRadiDataRec()
//  
//******************************************************************************
void rspfCeosData::dumpRadiDataRec(ostream& stream) const
{
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::dumpRadiCompRec()
//  
//******************************************************************************
void rspfCeosData::dumpRadiCompRec(ostream& stream) const
{
...
//*****************************************************************************
// PRIVATE METHOD: rspfCeosData::loadCeosRecords()
//
//  Reads the data files and initializes the data members. 
//
//*****************************************************************************
void rspfCeosData::loadCeosRecords()
{
   static const char MODULE[] = "rspfCeosData::loadCeosFile()";
...
//******************************************************************************
// PRIVATE METHOD: rspfCeosData::sizeOfNextRec(FILE*)
//  
//  Reads the descriptor record pointed to by the file ptr and returns the
//  size of the following record in bytes.
//  
//******************************************************************************
int rspfCeosData::sizeOfNextRec(FILE* fptr)
{
   static const char MODULE[] = "rspfCeosData::sizeOfNextRec(FILE* fptr)";
   if (traceExec())  CLOG << "entering..." << endl;
