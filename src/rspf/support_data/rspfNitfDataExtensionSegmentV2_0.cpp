...
// 
//********************************************************************
// $Id: rspfNitfDataExtensionSegmentV2_0.cpp 13218 2008-07-23 19:22:37Z dburken $

#include <iostream>
#include <rspf/support_data/rspfNitfDataExtensionSegmentV2_0.h>


RTTI_DEF1(rspfNitfDataExtensionSegmentV2_0, "rspfNitfDataExtensionSegmentV2_0",rspfNitfDataExtensionSegment)
...
rspfNitfDataExtensionSegmentV2_0::rspfNitfDataExtensionSegmentV2_0()
{
   clearFields();
}
...
void rspfNitfDataExtensionSegmentV2_0::parseStream(std::istream &in)
{
   if(in)
   {
      clearFields();
      ...
      if(rspfString(theIdentSecurityChunk.theDataExtSecuityDowngrade) == "999998")
      {
      ...
      // to see what it is
      long length = rspfString(theLengthOfUserDefinedSubheaderFields).toLong();
      ...
      if(rspfString(theIdentSecurityChunk.theUniqueDataExtTypeId).trim().upcase() == "REGISTERED EXTENSIONS")
      {
         theTag.clearFields();
...
void rspfNitfDataExtensionSegmentV2_0::clearFields()
{
...
std::ostream& rspfNitfDataExtensionSegmentV2_0::print(std::ostream& out)const
{
