...
// 
//********************************************************************
// $Id: rspfNitfSymbolHeaderV2_0.cpp 9094 2006-06-13 19:12:40Z dburken $
...
RTTI_DEF1(rspfNitfSymbolHeaderV2_0, "rspfNitfSymbolHeaderV2_0", rspfNitfSymbolHeader)

rspfNitfSymbolHeaderV2_0::rspfNitfSymbolHeaderV2_0()
{
   clearFields();
}

void rspfNitfSymbolHeaderV2_0::parseStream(std::istream &in)
{
   if(in)
   {
      clearFields();
      ...
      if(rspfString(theSymbolSecurityDowngrade) == "999998")
      {
      ...
      in.ignore(rspfString(theSymbolNumberOfLutEntries).toLong());
...
std::ostream& rspfNitfSymbolHeaderV2_0::print(std::ostream &out)const
{
...
rspf_int32 rspfNitfSymbolHeaderV2_0::getDisplayLevel() const
{
   return rspfString(theSymbolDisplayLevel).toInt32();
}

rspfDrect rspfNitfSymbolHeaderV2_0::getImageRect()const
{
   ...
   return rspfDrect(0,0,0,0);
}


void rspfNitfSymbolHeaderV2_0::clearFields()
{   
