...
//
//********************************************************************
// $Id: rspfFfRevc.cpp 13217 2008-07-23 19:19:13Z dburken $
...
#include <rspf/support_data/rspfFfRevc.h>
...
//***************************************************************************
// CONSTRUCTOR:
// rspfFfRevc::rspfFfRevc(const char* headerFile)
//
   ...
   theErrorStatus(RSPF_OK)
{
   ...
   if (!is)
   {
      ...
      rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfFfRevc::rspfFfRevc(header): "
...
//***************************************************************************
// PUBLIC METHOD:
// int rspfFfRevc::path(int sceneNbr) const
//
...
//***************************************************************************
// PUBLIC METHOD:
// int rspfFfRevc::row(int sceneNbr) const
//
...
//***************************************************************************
// PUBLIC METHOD:
// int rspfFfRevc::fraction(int sceneNbr) const
//
...
//***************************************************************************
// PUBLIC METHOD:
// int rspfFfRevc::subScene(int sceneNbr) const
//
// Convenience method to parse the subScene from the path/row string.  Returns
// zero if stream is not opened.  Current loacation field is:
// path/row/fraction/subscene in ppp/rrrffss format.
//***************************************************************************
rspfString rspfFfRevc::subScene(int sceneNbr) const
{
   char   tmpBuff[3];
   rspfString subScene;
...
//***************************************************************************
// rspfFfRevc::pathRow(int sceneNbr)
//***************************************************************************
rspfString rspfFfRevc::pathRow(int sceneNbr) const
{
   rspfString tmp = "p";
...
//***************************************************************************
// PUBLIC METHOD:
// void rspfFfRevc::print(ostream& os) const
//
// Prints data members.
//***************************************************************************
void rspfFfRevc::print(ostream& os) const
...
//***************************************************************************
// PUBLIC METHOD:
// void rspfFfRevc::write(ostream& os) const
//
...
//***************************************************************************
// PRIVATE METHOD:
// rspfFfRevc::loadFromStream(istream& is)
//***************************************************************************
void rspfFfRevc::loadFromStream(istream& is)
{
   //***
...
int rspfFfRevc::checkStream(istream& is)
{
   ...
   if (!is)
   {
      ...
      rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfFfRevc::checkStream: "
...
//***************************************************************************
// Function:
// ostream& operator<<(ostream& os, const rspfFfRevc& head)
//***************************************************************************
ostream& operator<<(ostream& os, const rspfFfRevc& head)
{
   head.print(os);
...
//***************************************************************************
// CONSTRUCTOR:
// rspfFfRevc::AdminRecord::AdminRecord()
//
...
//***************************************************************************
// CONSTRUCTOR:
// rspfFfRevc::RadiomRecord::RadiomRecord()
//
...
//***************************************************************************
// CONSTRUCTOR:
// rspfFfRevc::GeoRecord::GeomRecord()
//
// Default constructor for GeoRecord nested class:
//***************************************************************************
rspfFfRevc::GeoRecord::GeoRecord()
   :
      theUlEasting(0.0),
      theUlNorthing(0.0),
      theUrEasting(0.0),
