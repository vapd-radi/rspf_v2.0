...
rspfNitfCsproaTag::rspfNitfCsproaTag()
   : rspfNitfRegisteredTag(std::string("CSPROA"), 120)
{
   clearFields();
}

void rspfNitfCsproaTag::parseStream(std::istream& in)
{
...
void rspfNitfCsproaTag::writeStream(std::ostream& out)
{
...
std::ostream& rspfNitfCsproaTag::print(std::ostream& out,
...
void rspfNitfCsproaTag::clearFields()
{
