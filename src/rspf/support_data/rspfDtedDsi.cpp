...
//
//********************************************************************
// $Id: rspfDtedDsi.cpp 17206 2010-04-25 23:20:40Z dburken $
...
// CONSTRUCTOR
//**************************************************************************
rspfDtedDsi::rspfDtedDsi(const rspfFilename& dted_file, rspf_int32 offset)
   :
      theRecSen(),
      theSecurityCode(),
      theField3(),
      ...
      theStopOffset(0)
{
   if(!dted_file.empty())
   {
      ...
      if(!dted_file.exists())
      {
         ...
         rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfDtedDsi::rspfDtedDsi: \nThe DTED file does not exist: " << dted_file << std::endl;
         return;
      }
      ...
      {
         theErrorStatus = rspfErrorCodes::RSPF_ERROR;
         rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfDtedDsi::rspfDtedDsi: The DTED file is not readable: " << dted_file << std::endl;
         return;
      }
      ...
      {
         theErrorStatus = rspfErrorCodes::RSPF_ERROR;
         rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfDtedDsi::rspfDtedDsi: Unable to open the DTED file: " << dted_file << std::endl;
         return;
      }
      in.seekg(offset);
      parse(in);
...
// CONSTRUCTOR
//**************************************************************************
rspfDtedDsi::rspfDtedDsi(std::istream&  in)
   :
      theRecSen(),
      theSecurityCode(),
      theField3(),
...
void rspfDtedDsi::parse(std::istream& in)
{
   clearErrorStatus();
...
rspfRefPtr<rspfProperty> rspfDtedDsi::getProperty(
...
void rspfDtedDsi::getPropertyNames(
   std::vector<rspfString>& propertyNames) const
{
   propertyNames.push_back(rspfString("dted_dsi_record"));
}

rspfString rspfDtedDsi::recognitionSentinel() const
{
   return theRecSen;
}

rspfString rspfDtedDsi::securityCode() const
{
   return rspfString(theSecurityCode);
}

rspfString rspfDtedDsi::productLevel() const
{
   return rspfString(theProductLevel);
}

rspfString rspfDtedDsi::edition() const
{
   return rspfString(theEdition);
}

rspfString rspfDtedDsi::matchMergeVersion() const
{
   return rspfString(theMatchMergeVersion);
}

rspfString rspfDtedDsi::maintanenceDate() const
{
   return rspfString(theMaintenanceDate);
}

rspfString rspfDtedDsi::matchMergeDate() const
{
   return rspfString(theMatchMergeDate);
}

rspfString rspfDtedDsi::maintenanceCode() const
{
   return rspfString(theMaintenanceCode);
}

rspfString rspfDtedDsi::producerCode() const
{
   return rspfString(theProducerCode);
}

rspfString rspfDtedDsi::productStockSpecNumber() const
{
   return rspfString(theProductStockSpecNumber);
}

rspfString rspfDtedDsi::productSpecNumber() const
{
   return rspfString(theProductSpecNumber);
}

rspfString rspfDtedDsi::productSpecDate() const
{
   return rspfString(theProductSpecDate);
}

rspfString rspfDtedDsi::verticalDatum() const
{
   return rspfString(theVerticalDatum);
}

rspfString rspfDtedDsi::horizontalDatum() const
{
   return rspfString(theHorizontalDatum);
}

rspfString rspfDtedDsi::compilationDate() const
{
   return rspfString(theCompilationDate);
}

rspfString rspfDtedDsi::latOrigin() const
{
   return rspfString(theLatOrigin);
}

rspfString rspfDtedDsi::lonOrigin() const
{
   return rspfString(theLonOrigin);
}

rspfString rspfDtedDsi::latSW() const
{
   return rspfString(theLatSW);
}

rspfString rspfDtedDsi::lonSW() const
{
   return rspfString(theLonSW);
}

rspfString rspfDtedDsi::latNW() const
{
   return rspfString(theLatNW);
}

rspfString rspfDtedDsi::lonNW() const
{
   return rspfString(theLonNW);
}

rspfString rspfDtedDsi::latNE() const
{
   return rspfString(theLatNE);
}

rspfString rspfDtedDsi::lonNE() const
{
   return rspfString(theLonNE);
}

rspfString rspfDtedDsi::latSE() const
{
   return rspfString(theLatSE);
}

rspfString rspfDtedDsi::lonSE() const
{
   return rspfString(theLonSE);
}

rspfString rspfDtedDsi::orientation() const
{
   return rspfString(theOrientation);
}

rspfString rspfDtedDsi::latInterval() const
{
   return rspfString(theLatInterval);
}

rspfString rspfDtedDsi::lonInterval() const
{
   return rspfString(theLonInterval);
}

rspf_int32  rspfDtedDsi::numLatPoints() const
{
   return (theNumLatPoints ? atoi(theNumLatPoints) : 0);
}

rspf_int32  rspfDtedDsi::numLonLines() const
{
   return (theNumLonLines ? atoi(theNumLonLines) : 0);
}

rspf_int32  rspfDtedDsi::cellIndicator() const
{
   return (theCellIndicator ? atoi(theCellIndicator) : 0);
}

rspf_int32 rspfDtedDsi::startOffset() const
{
   return theStartOffset;
}
rspf_int32 rspfDtedDsi::stopOffset() const
{
...
// operator <<
//**************************************************************************
std::ostream& operator<<( std::ostream& os, const rspfDtedDsi& dsi)
{
   std::string prefix;
   return dsi.print(os, prefix);
}

std::ostream& rspfDtedDsi::print(std::ostream& out,
...
rspfDtedDsi::rspfDtedDsi(const rspfDtedDsi& /* source */)
{}

const rspfDtedDsi& rspfDtedDsi::operator=(const rspfDtedDsi& rhs)
{
   return rhs;
}
