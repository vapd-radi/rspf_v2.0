...
// 
//********************************************************************
// $Id: rspfNitfFileHeaderV2_1.cpp 20123 2011-10-11 17:55:44Z dburken $
...
#include <rspf/support_data/rspfNitfDataExtensionSegmentV2_0.h> // ??? drb


RTTI_DEF1(rspfNitfFileHeaderV2_1,
          "rspfNitfFileHeaderV2_1",
          rspfNitfFileHeaderV2_X)

const rspfString rspfNitfFileHeaderV2_1::FSCLSY_KW  = "FSCLSY";
const rspfString rspfNitfFileHeaderV2_1::FSDCTP_KW  = "FSDCTP";
const rspfString rspfNitfFileHeaderV2_1::FSDCDT_KW  = "FSDCDT";
const rspfString rspfNitfFileHeaderV2_1::FSDCXM_KW  = "FSDCXM";
const rspfString rspfNitfFileHeaderV2_1::FSDG_KW    = "FSDG";
const rspfString rspfNitfFileHeaderV2_1::FSDGDT_KW  = "FSDGDT";
const rspfString rspfNitfFileHeaderV2_1::FSCLTX_KW  = "FSCLTX";
const rspfString rspfNitfFileHeaderV2_1::FSCATP_KW  = "FSCATP";
const rspfString rspfNitfFileHeaderV2_1::FSCRSN_KW  = "FSCRSN";
const rspfString rspfNitfFileHeaderV2_1::FSSRDT_KW  = "FSSRDT";
const rspfString rspfNitfFileHeaderV2_1::FBKGC_KW   = "FBKGC";

static const
rspfTrace traceDebug(rspfString("rspfNitfFileHeaderV2_1:debug"));
...
rspf_uint32 rspfNitfImageInfoRecordV2_1::getHeaderLength()const
{
   return rspfString(theImageSubheaderLength).toUInt32();
}

rspf_uint64 rspfNitfImageInfoRecordV2_1::getImageLength()const
{
   return rspfString(theImageLength).toUInt64();
}

rspf_uint64 rspfNitfImageInfoRecordV2_1::getTotalLength()const
{
...
void rspfNitfTextFileInfoRecordV2_1::setSubheaderLength(rspf_uint32 length)
{
   ostringstream out;
...
void rspfNitfTextFileInfoRecordV2_1::setTextLength(rspf_uint64 length)
{
   ostringstream out;
...
rspf_uint32 rspfNitfTextFileInfoRecordV2_1::getHeaderLength()const
{
   return rspfString(theTextFileSubheaderLength).toInt32();
}

rspf_uint32 rspfNitfTextFileInfoRecordV2_1::getTextLength()const
{
   return rspfString(theTextFileLength).toInt32();
}

rspf_uint32 rspfNitfTextFileInfoRecordV2_1::getTotalLength()const
{
...
void rspfNitfImageInfoRecordV2_1::setSubheaderLength(rspf_uint32 length)
{
   ostringstream out;
...
void rspfNitfImageInfoRecordV2_1::setImageLength(rspf_uint64 length)
{
   ostringstream out;
...
rspfNitfFileHeaderV2_1::rspfNitfFileHeaderV2_1()
   :rspfNitfFileHeaderV2_X()
{
   clearFields();
}
...
void rspfNitfFileHeaderV2_1::parseStream(std::istream& in)
{
   clearFields();
   ...
   // user defined data.
   std::streampos userDefinedHeaderLength = rspfString(theUserDefinedHeaderDataLength).toInt32();
   ...
   theHeaderSize += 5;
   std::streampos extendedHeaderDataLength = rspfString(theExtendedHeaderDataLength).toInt32();
...
void rspfNitfFileHeaderV2_1::writeStream(std::ostream &out)
{
   ...
   {
      rspfNotify(rspfNotifyLevel_WARN) << "WARNING rspfNitfFileHeaderV2_1::writeStream: Only support writing of total tag length < 99999" << std::endl;
   }
}

std::ostream& rspfNitfFileHeaderV2_1::print(std::ostream& out,
...
rspfNitfImageHeader* rspfNitfFileHeaderV2_1::allocateImageHeader()const
{
   return new rspfNitfImageHeaderV2_1;
}

rspfNitfTextHeader *rspfNitfFileHeaderV2_1::allocateTextHeader()const
{
   return new rspfNitfTextHeaderV2_0;
}

rspfNitfDataExtensionSegment* rspfNitfFileHeaderV2_1::allocateDataExtSegment()const
{
   return new rspfNitfDataExtensionSegmentV2_0;
}

bool rspfNitfFileHeaderV2_1::isEncrypted()const
{
   return (theEncryption[0]=='1');
}

rspf_int32 rspfNitfFileHeaderV2_1::getNumberOfImages()const
{
   return (rspf_int32)theNitfImageInfoRecords.size();
}

rspf_int32 rspfNitfFileHeaderV2_1::getNumberOfTextSegments()const
{
   return static_cast<rspf_int32>(theNitfTextFileInfoRecords.size());
}

rspf_int32 rspfNitfFileHeaderV2_1::getHeaderSize()const
{
   return theHeaderSize;
}

rspf_int64 rspfNitfFileHeaderV2_1::getFileSize()const
{
...
const char* rspfNitfFileHeaderV2_1::getVersion()const
{
   return &theFileTypeVersion[4];
}


void rspfNitfFileHeaderV2_1::clearFields()
{
...
void rspfNitfFileHeaderV2_1::readImageInfoRecords(std::istream &in)
{
   ...
   {
      rspfNitfImageInfoRecordV2_1 temp;
...
void rspfNitfFileHeaderV2_1::readGraphicInfoRecords(std::istream &in)
{
   rspf_int32 numberOfGraphics = rspfString(theNumberOfGraphicInfoRecords).toInt32();
   rspf_int32 index;
   ...
   {
      rspfNitfGraphicInfoRecordV2_1 temp;
...
void rspfNitfFileHeaderV2_1::readTextFileInfoRecords(std::istream &in)
{
   ...
   {
      rspfNitfTextFileInfoRecordV2_1 temp;
...
void rspfNitfFileHeaderV2_1::readDataExtSegInfoRecords(std::istream &in)
{
   ...
   {
      rspfNitfDataExtSegInfoRecordV2_1 temp;
...
void rspfNitfFileHeaderV2_1::readResExtSegInfoRecords(std::istream &in)
{
   ...
   {
      rspfNitfResExtSegInfoRecordV2_1 temp;
...
rspf_int32 rspfNitfFileHeaderV2_1::getNumberOfLabels()const
{
   return 0;
}

rspf_int32 rspfNitfFileHeaderV2_1::getNumberOfSymbols()const
{
   return 0;
}

rspf_int32 rspfNitfFileHeaderV2_1::getNumberOfGraphics()const
{
   return 0;
}

rspf_int32 rspfNitfFileHeaderV2_1::getNumberOfDataExtSegments()const
{
   return 0;
}

const char* rspfNitfFileHeaderV2_1::getDateTime()const
{
   return theDateTime;
}

rspfDrect rspfNitfFileHeaderV2_1::getImageRect()const
{
   return theImageRect;
}

void rspfNitfFileHeaderV2_1::addImageInfoRecord(const rspfNitfImageInfoRecordV2_1& recordInfo)
{
...
void rspfNitfFileHeaderV2_1::addTextInfoRecord(const rspfNitfTextFileInfoRecordV2_1& recordInfo)
{
...
void rspfNitfFileHeaderV2_1::addDataExtSegInfoRecord(const rspfNitfDataExtSegInfoRecordV2_1& recordInfo)
{
...
void rspfNitfFileHeaderV2_1::replaceImageInfoRecord(int i, const rspfNitfImageInfoRecordV2_1& recordInfo)
{
...
rspfNitfSymbolHeader *rspfNitfFileHeaderV2_1::allocateSymbolHeader()const
{
   return 0;
}

rspfNitfLabelHeader *rspfNitfFileHeaderV2_1::allocateLabelHeader()const
{
   return 0;
}

void rspfNitfFileHeaderV2_1::initializeAllOffsets()
{
   ...
   for(idx = 0; idx < theNitfImageInfoRecords.size(); ++idx)
   {
      theImageOffsetList.push_back(rspfNitfImageOffsetInformation(tally,
                                                                   tally + (rspf_uint64)theNitfImageInfoRecords[idx].getHeaderLength()));
...
rspfNitfImageHeader*
rspfNitfFileHeaderV2_1::getNewImageHeader(rspf_uint32 imageNumber,
                                           std::istream& in)const
{
   ...
   {
#if 0
      rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfNitfFileHeaderV2_1::getNewImageHeader: "
...
rspfNitfFileHeaderV2_1::getNewSymbolHeader(rspf_uint32 /* symbolNumber */,
                                            std::istream& /* in */)const
{
...
rspfNitfLabelHeader*
rspfNitfFileHeaderV2_1::getNewLabelHeader(rspf_uint32 /* labelNumber */,
                                           std::istream& /* in */)const
{
   // Currently not implemented...
...
rspfNitfTextHeader*
rspfNitfFileHeaderV2_1::getNewTextHeader(rspf_uint32 /* textNumber */,
                                          std::istream& /* in */)const
{
   // Currently not implemented...
...
rspfNitfFileHeaderV2_1::getNewDataExtensionSegment(
...
rspfString rspfNitfFileHeaderV2_1::getSecurityClassificationSys()const
{
   return theSecurityClassificationSys;
}

rspfString rspfNitfFileHeaderV2_1::getCodeWords()const
{
   return theCodewords;
}

rspfString rspfNitfFileHeaderV2_1::getControlAndHandling()const
{
   return theControlAndHandling;
}

rspfString rspfNitfFileHeaderV2_1::getReleasingInstructions()const
{
   return theReleasingInstructions;
}

rspfString rspfNitfFileHeaderV2_1::getDeclassificationType()const
{
   return theDeclassificationType;
}

rspfString rspfNitfFileHeaderV2_1::getDeclassificationDate()const
{
   return theDeclassificationDate;
}

rspfString rspfNitfFileHeaderV2_1::getDeclassificationExemption()const
{
   return theDeclassificationExemption;
}

rspfString rspfNitfFileHeaderV2_1::getDowngrade()const
{
   return theDowngrade;
}

rspfString rspfNitfFileHeaderV2_1::getDowngradingDate()const
{
   return theDowngradingDate;
}

rspfString rspfNitfFileHeaderV2_1::getClassificationText()const
{
   return theClassificationText;
}

rspfString rspfNitfFileHeaderV2_1::getClassificationAuthorityType()const
{
   return theClassificationAuthorityType;
}

rspfString rspfNitfFileHeaderV2_1::getClassificationAuthority()const
{
   return theClassificationAuthority;
}

rspfString rspfNitfFileHeaderV2_1::getClassificationReason()const
{
   return theClassificationReason;
}

rspfString rspfNitfFileHeaderV2_1::getSecuritySourceDate()const
{
   return theSecuritySourceDate;
}

rspfString rspfNitfFileHeaderV2_1::getSecurityControlNumber()const
{
   return theSecurityControlNumber;
}

void rspfNitfFileHeaderV2_1::getBackgroundColor(rspf_uint8& r,
                                                 rspf_uint8& g,
                                                 rspf_uint8& b)const
{
...
rspfString rspfNitfFileHeaderV2_1::getOriginatorsName()const
{
   return theOriginatorsName;
}

rspfString rspfNitfFileHeaderV2_1::getOriginatorsPhone()const
{
   return theOriginatorsPhone;
}

void rspfNitfFileHeaderV2_1::setFileLength(rspf_uint64 fileLength)
{
   ostringstream out;
...
void rspfNitfFileHeaderV2_1::setNumberOfGraphicInfoRecords(rspf_uint64 num)
	{
		if (num < 1000)
   {
      ostringstream out;
   ...
   {
      std::string s = "rspfNitfFileHeaderV2_1::setNumberOfGraphicInfoRecords:";
...
void rspfNitfFileHeaderV2_1::setNumberOfDataExtSegInfoRecords(rspf_uint64 num)
{
   if (num < 1000)
   {
      ostringstream out;
   ...
   {
      std::string s = "rspfNitfFileHeaderV2_1::setNumberOfDataExtSegInfoRecords:";
      s += " ERROR\nExceeded max number of 999!";
      if (traceDebug())
      {
         rspfNotify(rspfNotifyLevel_WARN) << s << std::endl;
...
void rspfNitfFileHeaderV2_1::setNumberOfTextInfoRecords(rspf_uint64 num)
{
   if (num < 1000)
   {
      ostringstream out;
   ...
   {
      std::string s = "rspfNitfFileHeaderV2_1::setNumberOfTextRecords:";
      s += " ERROR\nExceeded max number of 999!";
      if (traceDebug())
      {
         rspfNotify(rspfNotifyLevel_WARN) << s << std::endl;
...
void rspfNitfFileHeaderV2_1::setNumberOfImageInfoRecords(rspf_uint64 num)
{
   if (num < 1000)
   {
      ostringstream out;
   ...
   {
      std::string s = "rspfNitfFileHeaderV2_1::setNumberOfImageInfoRecords:";
...
void rspfNitfFileHeaderV2_1::setHeaderLength(rspf_uint64 headerLength)
{
   ostringstream out;
...
void rspfNitfFileHeaderV2_1::setSecurityClassificationSys(const rspfString& value)
{
   ...
   out << std::setw(2)
       ...
       << rspfString(value).trim();

   memcpy(theSecurityClassificationSys, out.str().c_str(), 1);
}

void rspfNitfFileHeaderV2_1::setCodeWords(const rspfString& codeWords)
{
   std::ostringstream out;
   ...
   out << std::setw(11)
       << std::setfill(' ')
       << std::setiosflags(ios::left)
       << rspfString(codeWords).trim();

   memcpy(theCodewords, out.str().c_str(), 1);
}

void rspfNitfFileHeaderV2_1::setControlAndHandling(const rspfString& controlAndHandling)
{
   std::ostringstream out;
   ...
   out << std::setw(2)
       << std::setfill(' ')
       << std::setiosflags(ios::left)
       << rspfString(controlAndHandling).trim();

   memcpy(theControlAndHandling, out.str().c_str(), 1);
}

void rspfNitfFileHeaderV2_1::setReleasingInstructions(const rspfString& releasingInstructions)
{
   std::ostringstream out;
   ...
   out << std::setw(2)
       << std::setfill(' ')
       << std::setiosflags(ios::left)
       << rspfString(releasingInstructions).trim();

   memcpy(theReleasingInstructions, out.str().c_str(), 1);
}

void rspfNitfFileHeaderV2_1::setDeclassificationType(const rspfString& declassType)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setDeclassificationDate(const rspfLocalTm& d)
{
   memcpy(theDeclassificationDate, formatDate(getVersion(), d).c_str(), 8);
}

void rspfNitfFileHeaderV2_1::setDeclassificationDate(const rspfString& d)
{
   if(d.size() >=8)
   {
...
void rspfNitfFileHeaderV2_1::setDeclassificationExemption(const rspfString& exemption)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setDowngrade(const rspfString& downgrade)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setDowngradingDate(const rspfLocalTm& d)
{
   memcpy(theDowngradingDate, formatDate(getVersion(), d).c_str(), 8);
}

void rspfNitfFileHeaderV2_1::setDowngradingDate(const rspfString& d)
{
   if(d.size() >=8)
   {
...
void rspfNitfFileHeaderV2_1::setClassificationText(const rspfString& classificationText)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setClassificationAuthorityType(const rspfString& authorityType)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setClassificationAuthority(const rspfString& authority)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setClassificationReason(const rspfString& reason)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setSecuritySourceDate(const rspfLocalTm& d)
{
   memcpy(theSecuritySourceDate, formatDate(getVersion(), d).c_str(), 8);
}

void rspfNitfFileHeaderV2_1::setSecuritySourceDate(const rspfString& d)
{
   if(d.size() >=8)
   {
...
void rspfNitfFileHeaderV2_1::setSecurityControlNumber(const rspfString& number)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setFileBackgroundColor(rspf_uint8 r,
                                                     rspf_uint8 g,
                                                     rspf_uint8 b)
{
...
void rspfNitfFileHeaderV2_1::setOriginatorsName(const rspfString& name)
{
   std::ostringstream out;
...
void rspfNitfFileHeaderV2_1::setOriginatorsPhone(const rspfString& phone)
{
   std::ostringstream out;
...
bool rspfNitfFileHeaderV2_1::loadState(const rspfKeywordlist& kwl,
                                        const char* prefix)
{
   ...
   if ( lookup )
   {
      setSecurityClassificationSys( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSDCTP_KW);
   if ( lookup )
   {
      setDeclassificationType( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSDCDT_KW);
   if ( lookup )
   {
      setDeclassificationDate( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSDCXM_KW);
   if ( lookup )
   {
      setDeclassificationExemption( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSDG_KW);
   if ( lookup )
   {
      setDowngrade( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSDGDT_KW);
   if ( lookup )
   {
      setDowngradingDate( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSCLTX_KW );
   if ( lookup )
   {
      setClassificationText( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSCATP_KW );
   if ( lookup )
   {
      setClassificationAuthorityType( rspfString(lookup) );
   }  
   lookup = kwl.find( prefix, FSCRSN_KW );
   if ( lookup )
   {
      setClassificationReason( rspfString(lookup) );
   }  
   ...
   if ( lookup )
   {
      setSecuritySourceDate( rspfString(lookup) );
   }  
   ...
   if ( lookup )
   {
      ...
      {
         setFileBackgroundColor((rspf_uint8)splitString[0].toUInt32(), 
                                (rspf_uint8)splitString[1].toUInt32(), 
                                (rspf_uint8)splitString[2].toUInt32());
      }
   }  
   
   return rspfNitfFileHeaderV2_X::loadState(kwl, prefix);
}

void rspfNitfFileHeaderV2_1::setProperty(rspfRefPtr<rspfProperty> property)
{
...
rspfRefPtr<rspfProperty> rspfNitfFileHeaderV2_1::getProperty(const rspfString& name)const
{
   rspfProperty* property = 0;
   rspfStringProperty* stringProperty = 0;
   rspfColorProperty* colorProperty = 0;

   if(name == CLEVEL_KW)
   {
      property = new rspfStringProperty(name, getComplexityLevel().trim());
   }
   ...
   {
      stringProperty = new rspfStringProperty(name,
                                               getDowngrade().trim(),
                                               false);
   ...
   else if(name == FBKGC_KW)
   {
      ...
      colorProperty = new rspfColorProperty(name,
                                             rspfRgbVector(r, g, b));
...
void rspfNitfFileHeaderV2_1::getPropertyNames(std::vector<rspfString>& propertyNames)const
{
