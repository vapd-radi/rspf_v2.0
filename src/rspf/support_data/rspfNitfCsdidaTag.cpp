...
RTTI_DEF1(rspfNitfCsdidaTag, "rspfNitfCsdidaTag", rspfNitfRegisteredTag);

rspfNitfCsdidaTag::rspfNitfCsdidaTag()
   : rspfNitfRegisteredTag(std::string("CSDIDA"), 70)
{
   clearFields();
}
...
void rspfNitfCsdidaTag::parseStream(std::istream& in)
{
   clearFields();
...
void rspfNitfCsdidaTag::writeStream(std::ostream& out)
{
   out.write(theDay, 2);
...
void rspfNitfCsdidaTag::clearFields()
{
...
std::ostream& rspfNitfCsdidaTag::print(
