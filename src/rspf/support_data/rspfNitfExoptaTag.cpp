...
rspfNitfExoptaTag::rspfNitfExoptaTag()
   : rspfNitfRegisteredTag(std::string("EXOPTA"), CEL_SIZE) 
{
   clearFields();   
}

void rspfNitfExoptaTag::parseStream(std::istream& in)
{
   clearFields();
...
void rspfNitfExoptaTag::writeStream(std::ostream& out)
{
...
std::ostream& rspfNitfExoptaTag::print(std::ostream& out,
...
void rspfNitfExoptaTag::clearFields()
{
