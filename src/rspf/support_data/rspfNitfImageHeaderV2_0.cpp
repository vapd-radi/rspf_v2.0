...
// 
//********************************************************************
// $Id: rspfNitfImageHeaderV2_0.cpp 21518 2012-08-22 21:15:56Z dburken $
...
static const rspfTrace traceDebug(rspfString("rspfNitfImageHeaderV2_0:debug"));

RTTI_DEF1(rspfNitfImageHeaderV2_0,
          "rspfNitfImageHeaderV2_0",
          rspfNitfImageHeaderV2_X);

const rspfString rspfNitfImageHeaderV2_0::ISCODE_KW = "iscode";
const rspfString rspfNitfImageHeaderV2_0::ISCTLH_KW = "isctlh";
const rspfString rspfNitfImageHeaderV2_0::ISREL_KW = "isrel";
const rspfString rspfNitfImageHeaderV2_0::ISCAUT_KW = "iscaut";
const rspfString rspfNitfImageHeaderV2_0::CTLN_KW = "ctln";
const rspfString rspfNitfImageHeaderV2_0::ISDWNG_KW = "isdwng";
const rspfString rspfNitfImageHeaderV2_0::ISDEVT_KW = "isdevt";

rspfNitfImageHeaderV2_0::rspfNitfImageHeaderV2_0()
{
   clearFields();
}
...
void rspfNitfImageHeaderV2_0::parseStream(std::istream &in)
{
   clearFields();
   theImageBands.clear();
      
   in.read(theType, 2);
   if(rspfString(theType) != "IM")
   {
      // error
   }
   ...
   rspf_uint32 numberOfComments = rspfString(theNumberOfComments).toInt32();
   ...
   rspf_uint32 numberOfBands = rspfString(theNumberOfBands).toUInt32();
   theImageBands.resize(numberOfBands);
   rspf_uint32 idx = 0;
   while(idx < numberOfBands)
   {
      theImageBands[idx] = new rspfNitfImageBandV2_0;
   ...
   std::streampos userDefinedDataLen = (std::streampos)rspfString(theUserDefinedImageDataLength).toUInt32();
   theTagList.clear();
   ...
   std::streampos extSubHeadLen = (std::streampos)rspfString(theExtendedSubheaderDataLen).toUInt32();
   start   = in.tellg();
   current = in.tellg();
   if(extSubHeadLen > 0)
   {
   ...
   {
      rspfRefPtr<rspfNitfVqCompressionHeader> compressionHeader =
         new rspfNitfVqCompressionHeader;
...
void rspfNitfImageHeaderV2_0::writeStream(std::ostream &out)
{
   out.write(theType, 2);
   ...
   if(rspfString(theCompression) != "NC")
   {
...
std::ostream& rspfNitfImageHeaderV2_0::print(std::ostream& out,
...
bool rspfNitfImageHeaderV2_0::saveState(rspfKeywordlist& kwl, const rspfString& prefix)const
{
...
bool rspfNitfImageHeaderV2_0::isCompressed()const
{
   rspfString temp = theCompression;
   temp = temp.trim();
   return ((temp != "NC") &&
...
bool rspfNitfImageHeaderV2_0::isEncrypted()const
{
   return (theEncryption[0] == '1');
}

rspf_int32 rspfNitfImageHeaderV2_0::getNumberOfBands()const
{
   return rspfString(theNumberOfBands).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_0::getNumberOfRows()const
{
   return rspfString(theSignificantRows).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_0::getNumberOfCols()const
{
   return rspfString(theSignificantCols).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_0::getNumberOfBlocksPerRow()const
{
   return rspfString(theNumberOfBlocksPerRow).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_0::getNumberOfBlocksPerCol()const
{
   return rspfString(theNumberOfBlocksPerCol).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_0::getNumberOfPixelsPerBlockHoriz()const
{
   return rspfString(theNumberOfPixelsPerBlockHoriz).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_0::getNumberOfPixelsPerBlockVert()const
{
   return rspfString(theNumberOfPixelsPerBlockVert).toInt32();
}

rspfString rspfNitfImageHeaderV2_0::getImageId()const
{
   return theImageId;
}

rspf_int32 rspfNitfImageHeaderV2_0::getBitsPerPixelPerBand()const
{
   return rspfString(theNumberOfBitsPerPixelPerBand).toInt32();
}

rspf_int32 rspfNitfImageHeaderV2_0::getActualBitsPerPixelPerBand()const
{
   return rspfString(theActualBitsPerPixelPerBand).toInt32();
}

rspfString rspfNitfImageHeaderV2_0::getIMode() const
{
   return rspfString(theImageMode).trim();
}

rspfString rspfNitfImageHeaderV2_0::getSecurityClassification()const
{
   return rspfString(theSecurityClassification);
}

rspfString  rspfNitfImageHeaderV2_0::getImageDateAndTime() const
{
   return rspfString(theDateTime);
}

rspfString rspfNitfImageHeaderV2_0::getAcquisitionDateMonthDayYear(rspf_uint8 separationChar)const
{
   rspfString result;
   rspfString month(theDateTime+9,
                     theDateTime+12);
   ...
   result += rspfString(theDateTime,
                         theDateTime + 2);
   result += rspfString(separationChar);
   rspfString year(theDateTime+12,
                    theDateTime+14);
   if(year.toUInt32() < 70)
   {
      result += "20";
   ...
   result += rspfString(theDateTime+12,
                         theDateTime+14);

   return result;
}

rspfString rspfNitfImageHeaderV2_0::getCategory()const
{
   return theCategory;
}

rspfString rspfNitfImageHeaderV2_0::getImageSource()const
{
   return theImageSource;
}

rspfString rspfNitfImageHeaderV2_0::getRepresentation()const
{
   return theRepresentation;
}

rspfString rspfNitfImageHeaderV2_0::getCoordinateSystem()const
{
	return theCoordinateSystem;
}

rspfString rspfNitfImageHeaderV2_0::getPixelValueType()const
{
   return rspfString(thePixelValueType).trim();
}

bool rspfNitfImageHeaderV2_0::hasBlockMaskRecords()const
{
   return (theBlockMaskRecords.size() > 0);
}

bool rspfNitfImageHeaderV2_0::hasPadPixelMaskRecords()const
{
   return (thePadPixelMaskRecords.size() > 0);
}

bool rspfNitfImageHeaderV2_0::hasTransparentCode()const
{
   return (theTransparentOutputPixelCodeLength > 0);
}

rspf_uint32 rspfNitfImageHeaderV2_0::getTransparentCode()const
{
   return thePadOutputPixelCode;
}

rspf_uint32 rspfNitfImageHeaderV2_0::getBlockMaskRecordOffset(rspf_uint32 blockNumber,
...
rspf_uint32 rspfNitfImageHeaderV2_0::getPadPixelMaskRecordOffset(rspf_uint32 blockNumber,
                                                                   rspf_uint32 bandNumber)const
{
   rspf_uint32 maxBlock = getNumberOfBlocksPerRow()*getNumberOfBlocksPerCol();
   rspf_uint32 result = 0xffffffff;
...
void rspfNitfImageHeaderV2_0::clearFields()
{
   theTagList.clear();
...
const rspfRefPtr<rspfNitfCompressionHeader> rspfNitfImageHeaderV2_0::getCompressionHeader()const
{
   return theCompressionHeader;
}

const rspfRefPtr<rspfNitfImageBand> rspfNitfImageHeaderV2_0::getBandInformation(rspf_uint32 idx)const
{
...
void rspfNitfImageHeaderV2_0::setNumberOfBands(rspf_uint32 nbands)
{
   std::ostringstream out;
   if(nbands > 9)
   {
      if(traceDebug())
      {
         rspfNotify(rspfNotifyLevel_WARN) << "rspfNitfImageHeaderV2_0::setNumberOfBands: NBANDS is too large.  For 2.0 spec we can only have up to 9 bands\n";
      }
      std::string s = "rspfNitfImageHeaderV2_0::setNumberOfBands:";
...
void rspfNitfImageHeaderV2_0::setBandInfo(rspf_uint32 idx,
...
void rspfNitfImageHeaderV2_0::setNumberOfRows(rspf_uint32 rows)
{
   std::ostringstream out;
...
void rspfNitfImageHeaderV2_0::setNumberOfCols(rspf_uint32 cols)
{
   std::ostringstream out;
...
void rspfNitfImageHeaderV2_0::setProperty(rspfRefPtr<rspfProperty> property)
{
   rspfNitfImageHeaderV2_X::setProperty(property);
}

rspfRefPtr<rspfProperty> rspfNitfImageHeaderV2_0::getProperty(const rspfString& name)const
{
   rspfRefPtr<rspfProperty> property = 0;
   if(name == ISCODE_KW)
   {
      property = new rspfStringProperty(name, theCodewords);
   }
   else if(name == ISCTLH_KW)
   {
      property = new rspfStringProperty(name, theControlAndHandling);
   }
   else if(name == ISREL_KW)
   {
      property = new rspfStringProperty(name, theReleasingInstructions);
   }
   else if(name == ISCAUT_KW)
   {
      property = new rspfStringProperty(name, theClassificationAuthority);
   }
   else if(name == CTLN_KW)
   {
      property = new rspfStringProperty(name, theSecurityControlNumber);
   }
   else if(name == ISDWNG_KW)
   {
      property = new rspfStringProperty(name, theSecurityDowngrade);
   }
   else if(name == ISDEVT_KW)
   {
      property = new rspfStringProperty(name, theDowngradingEvent);
   }
   else 
   {
      property = rspfNitfImageHeaderV2_X::getProperty(name);
   }
   return property;
}

void rspfNitfImageHeaderV2_0::getPropertyNames(std::vector<rspfString>& propertyNames)const
{
