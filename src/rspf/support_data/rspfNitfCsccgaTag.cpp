...
rspfNitfCsccgaTag::rspfNitfCsccgaTag()
   : rspfNitfRegisteredTag(std::string("CSCCGA"), CEL_SIZE)
{
   clearFields();
}

void rspfNitfCsccgaTag::parseStream(std::istream& in)
{
...
void rspfNitfCsccgaTag::writeStream(std::ostream& out)
{
...
std::ostream& rspfNitfCsccgaTag::print(std::ostream& out,
...
void rspfNitfCsccgaTag::clearFields()
{
