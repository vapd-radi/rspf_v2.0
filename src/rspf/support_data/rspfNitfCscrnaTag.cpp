...
RTTI_DEF1(rspfNitfCscrnaTag, "rspfNitfCscrnaTag", rspfNitfRegisteredTag);

rspfNitfCscrnaTag::rspfNitfCscrnaTag()
   : rspfNitfRegisteredTag(std::string("CSCRNA"), 109)
{
   clearFields();
}
...
void rspfNitfCscrnaTag::parseStream(std::istream& in)
{
   clearFields();
...
void rspfNitfCscrnaTag::writeStream(std::ostream& out)
{
...
void rspfNitfCscrnaTag::clearFields()
{
...
std::ostream& rspfNitfCscrnaTag::print(
