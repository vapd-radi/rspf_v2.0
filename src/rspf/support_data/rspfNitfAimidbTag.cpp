...
RTTI_DEF1(rspfNitfAimidbTag, "rspfNitfAimidbTag", rspfNitfRegisteredTag);

rspfNitfAimidbTag::rspfNitfAimidbTag()
   : rspfNitfRegisteredTag(std::string("AIMIDB"), CEL_SIZE)
{
   clearFields();
}
...
void rspfNitfAimidbTag::parseStream(std::istream& in)
{
   clearFields();
...
void rspfNitfAimidbTag::writeStream(std::ostream& out)
{
...
void rspfNitfAimidbTag::clearFields()
{
...
std::ostream& rspfNitfAimidbTag::print(
