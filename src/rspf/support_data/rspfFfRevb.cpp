...
//
//********************************************************************
// $Id: rspfFfRevb.cpp 13217 2008-07-23 19:19:13Z dburken $
...
//***************************************************************************
// CONSTRUCTOR:
// rspfFfRevb::rspfFfRevb(const char* headerFile)
//
   ...
   theErrorStatus(RSPF_OK)
{
   ...
   if (!is)
   {
      ...
      rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfFfRevb::rspfFfRevb(header):"
...
//***************************************************************************
// PUBLIC METHOD:
// int rspfFfRevb::path(int sceneNbr) const
//
...
//***************************************************************************
// PUBLIC METHOD:
// double rspfFfRevb::projParam(int paramNumber) const
//
...
double rspfFfRevb::projParam(int paramNumber) const
{
   ...
   {
      rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfFfRevb::projParam: "
   ...
   //***
   rspfString tmp = theUsgsProjParam[paramNumber];
   tmp.gsub("D", "E");
...
//***************************************************************************
// PUBLIC METHOD:
// void rspfFfRevb::print(ostream& os) const
//
// Prints data members.
//***************************************************************************
void rspfFfRevb::print(ostream& os) const
...
//***************************************************************************
// PUBLIC METHOD:
// void rspfFfRevb::write(ostream& os) const
//
...
//***************************************************************************
// PRIVATE METHOD:
// rspfFfRevb::loadFromStream(istream& is)
// Initializes data members from an EOSAT Fast Format Rev B header.
//***************************************************************************
void rspfFfRevb::loadFromStream(istream& is)
{
   if (!is)
   {
      theErrorStatus = RSPF_ERROR;

      rspfNotify(rspfNotifyLevel_FATAL) << "FATAL rspfFfRevb::loadFromStream:\n"
...
int rspfFfRevb::checkStream(istream& is)
{
   ...
   {
      theErrorStatus = RSPF_ERROR;
      rspfNotify(rspfNotifyLevel_FATAL) << "rspfFfRevb::checkStream ERROR: "
...
//***************************************************************************
// Function:
// ostream& operator<<(ostream& os, const rspfFfRevb& head)
//***************************************************************************
ostream& operator<<(ostream& os, const rspfFfRevb& head)
{
   head.print(os);
