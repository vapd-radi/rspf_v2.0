...
rspfJ2kSotRecord::rspfJ2kSotRecord()
   :
   theMarker(0xff90),
   theLsot(0),
   theIsot(0),
...
void rspfJ2kSotRecord::parseStream(std::istream& in)
{
...
std::ostream& rspfJ2kSotRecord::print(std::ostream& out,
...
std::ostream& operator<<(std::ostream& out, const rspfJ2kSotRecord& obj)
{
