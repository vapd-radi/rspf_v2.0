...
rspfLasHdr::rspfLasHdr(const rspfLasHdr& hdr) :
...
const rspfLasHdr& rspfLasHdr::operator=(const rspfLasHdr& copy_this)
{
   if (this != &copy_this)
   {
...
bool rspfLasHdr::checkSignature(std::istream& in) const
{
   bool result = false;
   char SIG[4];
   in.read(SIG, 4);
...
void rspfLasHdr::readStream(std::istream& in)
{
...
void rspfLasHdr::writeStream(std::ostream& out)
{
   if ( rspf::byteOrder() == RSPF_BIG_ENDIAN )
   {
...
std::ostream& rspfLasHdr::print(std::ostream& out) const
{
...
std::ostream& operator<<(std::ostream& out, const rspfLasHdr& hdr)
{
   return hdr.print(out);
}

void rspfLasHdr::getKeywordlist(rspfKeywordlist& kwl) const
{
...
bool rspfLasHdr::getGpsTimeTypeBit() const
{
   return (0x0001 & m_globalEncoding) ? true : false;
}

bool rspfLasHdr::getWaveforDataPacketsInternalBit() const
{
   return (0x0010 & m_globalEncoding) ? true : false;
}

bool rspfLasHdr::getWaveforDataPacketsExternalBit() const
{
   return (0x0100 & m_globalEncoding) ? true : false;
}

bool rspfLasHdr::getReturnsSyntheticallyGeneratedBit() const
{
   return (0x1000 & m_globalEncoding) ? true : false;
}

std::string rspfLasHdr::getProjectIdGuid() const
{
   ...
   for (int i=0; i<8; ++i)
   {
      rspf_uint16 uid = m_projectIdGuidData4[i];
      os << uid;
   }
   return os.str();
}

std::string rspfLasHdr::getVersion() const
{
   std::ostringstream os;
...
std::string  rspfLasHdr::getSystemIndentifier() const
{
   std::string s;
   s.reserve(32);
   for (int i=0; i<32; ++i)
...
std::string  rspfLasHdr::getGeneratingSoftware() const
{
   std::string s;
   s.reserve(32);
   for (int i=0; i<32; ++i)
...
rspf_uint16 rspfLasHdr::getHeaderSize() const
{
   return m_headerSize;
}

rspf_uint32 rspfLasHdr::getOffsetToPointData() const
{
   return m_offsetToPointData;
}

rspf_uint32 rspfLasHdr::getNumberOfVlrs() const
{
   return m_numberOfVariableLengthRecords;
}

rspf_uint8 rspfLasHdr::getPointDataFormatId() const
{
   return m_pointDataFormatId;
}

rspf_uint32 rspfLasHdr::getNumberOfPoints() const
{
   return m_numberOfPointRecords;
}

rspf_uint32 rspfLasHdr::getNumberOfPoints(rspf_uint32 entry) const
{
...
const rspf_float64& rspfLasHdr::getScaleFactorX() const
{
   return m_xScaleFactor;
}

const rspf_float64& rspfLasHdr::getScaleFactorY() const
{
   return m_yScaleFactor;
}

const rspf_float64& rspfLasHdr::getScaleFactorZ() const
{
   return m_zScaleFactor;
}

const rspf_float64& rspfLasHdr::getOffsetX() const
{
   return m_xOffset;
}

const rspf_float64& rspfLasHdr::getOffsetY() const
{
   return m_yOffset;
}

const rspf_float64& rspfLasHdr::getOffsetZ() const
{
   return m_zOffset;
}

const rspf_float64& rspfLasHdr::getMinX() const
{
   return m_minX;
}

const rspf_float64& rspfLasHdr::getMinY() const
{
   return m_minY;
}

const rspf_float64& rspfLasHdr::getMinZ() const
{
   return m_minZ;
}

const rspf_float64& rspfLasHdr::getMaxX() const
{
   return m_maxX;
}

const rspf_float64& rspfLasHdr::getMaxY() const
{
   return m_maxY;
}

const rspf_float64& rspfLasHdr::getMaxZ() const
{
   return m_maxZ;
}

void rspfLasHdr::swap()
{
   rspfEndian endian;
