...
//
//*******************************************************************
//  $Id: rspfDiscrete3x3HatFilter.cpp 11419 2007-07-27 16:24:57Z dburken $
#include <rspf/imaging/rspfDiscrete3x3HatFilter.h>
#include <rspf/base/rspfCommon.h>

rspfDiscrete3x3HatFilter::rspfDiscrete3x3HatFilter()
   :rspfDiscreteConvolutionKernel(3,3)
{
...
void rspfDiscrete3x3HatFilter::convolve(const float* data,
                                         double& result,
...
void rspfDiscrete3x3HatFilter::convolveSubImage(const float* data,
                                                 long dataWidth,
                                                 double& result,
                                                 float nullPixel)const
{
...
void rspfDiscrete3x3HatFilter::convolve(const unsigned char* data,
                                         double& result,
...
void rspfDiscrete3x3HatFilter::convolveSubImage(const unsigned char* data,
                                                 long dataWidth,
                                                 double& result,
                                                 rspf_uint8 nullPixel)const
{
...
void rspfDiscrete3x3HatFilter::buildConvolution(double xLocation,
                                                 double yLocation)
{
