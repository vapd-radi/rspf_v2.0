 ...
 *   Parameters:
 *A
 *    id         <input> == (rspf_int32) edge id number.
 *    edge_table <input> == (vpf_table_type) opened VPF table to read.
 *    return    <output> == (edge_rec_type) returned edge record.
 *E
 *::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 *   Parameters:
 *A
 *    id           <input> == (rspf_int32) face id number.
 ...
 *   Parameters:
 *A
 *    id           <input> == (rspf_int32) ring id number.
 ...
 *   Parameters:
 *A
 *    id            <input> == (rspf_int32) point id number.
 ...
 *   Parameters:
 *A
 *    id           <input> == (rspf_int32) annotation id.
