...
#ifdef __MSDOS__
#include <rspf/vpfutil/mapgraph.h>
#include <rspf/vpfutil/projectn.h>
#endif
#include <rspf/vpfutil/polygrf.h>
#ifdef __MSDOS__
#include "grprim.h"
#endif
#include <rspf/vpfutil/vpfrelat.h>
#include <rspf/vpfutil/vpfdraw.h>
 ...
 *   Parameters:
 *A
 *     rownum   <input>==(rspf_int32)row number of the edge primitive table.
 *     table    <input>==(vpf_table_type) edge table.
 *     return  <output>==(int) 0 if the user escapes, 1 upon successful
 *                          completion.
 *E
 ...
 *E
 *************************************************************************/
int draw_edge( rspf_int32 rownum, vpf_table_type table )
{
   int stat;
   row_type row;
 ...
 *   Parameters:
 *A
 *     rownum      <input>==(rspf_int32) row number of the entity node
 *                          primitive table.
 ...
 *E
 *************************************************************************/
int draw_point( rspf_int32 rownum, vpf_table_type table )
{
   int stat;
   row_type row;
 ...
 *   Parameters:
 *A
 *     rownum      <input>==(rspf_int32) row number of the text table.
 *     table       <input>==(vpf_table_type) text primitive table.
 *     return     <output>==(int) 0 if the user escapes, 1 upon successful
 *                          completion.
 *E
 ...
 *E
 *************************************************************************/
int draw_text( rspf_int32 rownum, vpf_table_type table )
{
   int stat;
   row_type row;
...
void gen_polygon_edge( edge_rec_type edge_rec,
		       ...
		       int wrap )
{
   register rspf_int32 i,start,end,inc;
   int xscr,yscr;
 ...
 *   Parameters:
 *A
 *     face_id    <input>==(rspf_int32) row id of the specified face.
 *     start_edge <input>==(rspf_int32) row id of the edge that starts the
 *                         loop.
 ...
 *E
 *************************************************************************/
void trace_polygon_loop(rspf_int32 face_id,
			rspf_int32 start_edge,
 ...
 *     prev_node  <inout>==(rspf_int32 *) the previous node visited.  This
 *                         value is updated by this function.
 *     face_id    <input>==(rspf_int32) row id of the specified face.
 *     next_polygon_edge <output>==(rspf_int32) the next edge id.  A value of -1
 ...
 *E
 *************************************************************************/
rspf_int32 next_polygon_edge( edge_rec_type *edge_rec, rspf_int32 *prevnode,
			    rspf_int32 face_id )
{
   rspf_int32 next;
 ...
 *E
 *************************************************************************/
void draw_polygon_loop(rspf_int32 face_id,
		       rspf_int32 start_edge,
		       vpf_table_type edgetable,
		       Shademap *poly,
		       int wrap )
 ...
 *   Parameters:
 *A
 *     row_num   <input>==(rspf_int32) row id of the specified face.
 *     facetable <input>==(vpf_table_type) VPF face primitive table.
 *     ringtable <input>==(vpf_table_type) VPF ring primitive table.
 *     edgetable <input>==(vpf_table_type) VPF edge primitive table.
 *     fbr       <input>==(vpf_table_type) VPF face bounding rectangle table.
 ...
 *E
 *************************************************************************/
void draw_face( rspf_int32 rownum,
		vpf_table_type facetable,
		vpf_table_type ringtable,
		vpf_table_type edgetable,
		vpf_table_type fbr,
 ...
 *E
 *************************************************************************/
void outline_polygon_loop(rspf_int32 face_id,
			  rspf_int32 start_edge,
			  vpf_table_type edgetable)
{
  edge_rec_type edge_rec;
 ...
 *E
 *************************************************************************/
void outline_face( rspf_int32 face_id,
		   vpf_table_type facetable,
		   vpf_table_type ringtable,
		   vpf_table_type edgetable,
		   color_type outline,
 ...
 *   Parameters:
 *A
 *     face_id  <input>==(rspf_int32) id of the face to be outlined.
 ...
 *E
 *************************************************************************/
void outline_face_table( rspf_int32 face_id, char *fname,
			 int color, int inner )
{
