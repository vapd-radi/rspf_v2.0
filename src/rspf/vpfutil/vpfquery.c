...
#endif
#include <stdio.h>
#include <rspf/vpfutil/linklist.h>
 ...
 *   Purpose:
 *P
 *     This function compares two rspf_int32 integers with the given logical
 *     operator.
 *E
 *::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 *
 *   Parameters:
 *A
 *    val1    <input>==(rspf_int32) first buffer to compare.
 *    val2    <input>==(rspf_int32) second buffer to compare.
 *    op      <input>==(char) logical operator.
 *    return <output>==(int) TRUE or FALSE.
 *E
 *::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 *E
 *************************************************************************/
static int icompare( rspf_int32 val1, rspf_int32 val2, char op )
{
   int result;
